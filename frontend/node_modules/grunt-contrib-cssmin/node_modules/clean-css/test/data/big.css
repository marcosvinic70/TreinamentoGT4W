...
@font-face {
	...
	src:
		url('/medias/web/font/svg/TheSerifOffice-OT7_West.svgz#TheSerifOffice')
		format('svg');
	src: url('/medias/web/font/eot/TheSerifOffice-TT7_.eot');
	src: url('/medias/web/font/eot/TheSerifOffice-TT7_.eot?#iefix')
...
@font-face {
	...
	src: url('/medias/web/font/eot/fetteengschrift.eot?#iefix')
		format('embedded-opentype'),
...
.txt15_120, .txt14_140, .txt14_120, .txt13_140, .txt13_120, .txt12,
	.txt11, .txt10 {
...
.btn_fonce, .bt_fonce a {
	...
	background-image: -webkit-gradient(linear, 0 0, 0 100%, from(#5d666d),
		to(#000b15));
	...
	background-repeat: repeat-x;
	filter: progid:DXImageTransform.Microsoft.gradient(startColorstr='#5d666d',
		endColorstr='#000b15', GradientType=0);
	border-color: #000b15;
...
.btn_abo {
	...
	background-image: -webkit-gradient(linear, 0 0, 0 100%, from(#ffe562),
		to(#ffc600));
	...
	background-repeat: repeat-x;
	filter: progid:DXImageTransform.Microsoft.gradient(startColorstr='#ffe562',
		endColorstr='#ffc600', GradientType=0);
	border-color: #ffc600;
	border-color: rgba(0, 0, 0, 0.1);
	filter: progid:dximagetransform.microsoft.gradient(enabled=false);
}
...
.btn:active, .btn.active, .btn.disabled, .btn.disabled:hover, input[type="submit"].disabled,
	.btn[disabled], .btn_petit:active, .btn_petit.active, .btn_petit[disabled]
	{
	background-color: #e6e6e6;
	color: #d2d6db;
}
...
.btn_fonce:hover, .btn_fonce:active, .btn_fonce.active, .btn_fonce.disabled,
	.btn_fonce[disabled] {
	color: #fff;
	background-color: #16212c;
}

.btn_abo:hover, .btn_abo:active, .btn_abo.active, .btn_abo.disabled,
	.btn_abo[disabled] {
	color: #2e3942;
	background-color: #ffc600;
}
...
*+html .fb20x20, *+html .tw20x20, *+html .google20x20, *+html .mobile20x20,
	*+html .rss20x20 {
	display: inline;
}
...
.fb13x13, .tw13x13, .google13x13, .linkedin13x13, .fb13x13_gris,
	.tw13x13_gris, .fb13x13_blanc, .tw13x13_blanc, .google13x13_blanc,
	.linkedin13x13_blanc, .tw_bird, .nb_reactions .pic, .nb_commentaires .pic,
	.lien_externe span, .bt_ouvrir, .bt_ouvrir:hover, .bt_fermer,
	.ico_annee_en_france, .croix_blanche, .croix_grise, .nl_blanc {
	background: url('/medias/web/img/sprites/icos_petites.png') no-repeat;
	display: inline-block;
	text-indent: -9999px;
	height: 13px;
...
.picto_lien {
	...
	height: 13px;
	margin: 0 5px 0 0;
	background: url('/medias/web/img/sprites/icos_petites.png') no-repeat 0
		-142px;
	vertical-align: middle;
}
...
.pic_debrief_abo {
	...
	width: 24px;
	height: 24px;
	background: url('/medias/web/img/sprites/pictos_abos.png') no-repeat 0
		-24px;
}
...
.titres_abonnes .entete, .entete_exclu_abonnes {
	...
	height: 19px;
	background: #ffd500
		url('/medias/web/img/elements_lm/ea_contenu_exclusif.png') no-repeat
		8px 4px;
	font-size: 13px;
	text-indent: -9999px;
}
...
.global.revue_web .entete {
	display: block;
	height: 80px;
	background: url('/medias/web/img/habillage/bandeau_revue_web.png')
		no-repeat;
}
...
.global.supp_partenaires .entete_deroule .logo {
	float: right;
	padding-left: 40px;
	background: url('/medias/web/img/textes/marqueur_pub_gris43x5.png') 0
		12px no-repeat;
}
...
.ico_univers_cine {
	display: inline-block;
	background-image:
		url('/medias/web/img/partenaires/evenement/logo-universcine-lemonde.png');
	text-indent: -9999px;
	position: absolute;
	bottom: 8%;
	right: 2%;
...
/** nature edito ***/
.ico_portfolio_mini, .ico_infographie_mini, .ico_video_mini,
	.ico_live_mini {
	display: inline-block;
	background-image: url('/medias/web/img/sprites/icos_medias.png');
}
...
.deplier {
	...
	text-indent: -9999px;
	background: #e4e6e9
		url('/medias/web/img/pictos/chevrons_double_haut_bas.png') no-repeat
		50% 3px;
...
.edito_ensemble_lien .double_chevron {
	...
	height: 9px;
	margin-left: 10px;
	background: url('/medias/web/img/pictos/chevrons_double_haut_bas.png')
		no-repeat;
}
...
.conteneur_onglets .onglet.courant {
	...
	background: -webkit-gradient(linear, left top, left bottom, color-stop(0%, #f1f5f8),
	...
	filter: progid:DXImageTransform.Microsoft.gradient( startColorstr='#f1f5f8',
		endColorstr='#ffffff', GradientType=0)
}

.conteneur_onglets .onglet>span, .conteneur_onglets .onglet>a,
	.conteneur_onglets .onglet .interieur_onglet {
	display: block;
	height: 35px;
	line-height: 36px;
	padding: 0 8px;
...
.lien_img314x64.festival_cannes_une {
	background:
		url('/medias/web/img/evenementiel/festival_de_cannes_2012/widget_une.png');
	text-indent: -9999px;
}

.lien_img314x64.legislatives_2012_une {
	background:
		url('/medias/web/img/evenementiel/legislatives_2012/widget_une.png');
	text-indent: -9999px;
}
...
/**********************************************/
	...
	/* FF3.6+ */
	background: -webkit-gradient(linear, left top, left bottom, color-stop(0%, #2d3143),
		color-stop(100%, #10141d)); /* Chrome,Safari4+ */
...
.ie #en_ce_moment a {
	...
	background: url('/medias/web/img/sprites/sous_nav.png') no-repeat right
		-70px;
...
.conteneur_pagination   .prev, .conteneur_pagination   .next {
	...
	background-image: -webkit-gradient(linear, 0 0, 0 100%, from(#fefefe),
		color-stop(25%, #fefefe), to(#e4e6e9));
	...
	filter: progid:DXImageTransform.Microsoft.gradient(startColorstr='#fefefe',
		endColorstr='#e4e6e9', GradientType=0);
	text-align: center;
	line-height: 26px;
	font-size: 15px;
	color: #2e3942;
...
.pagination .plus .pointeur {
	display: block;
	height: 12px;
	background: url('/medias/web/img/pictos/pagination_fle.png') no-repeat
		554px 0;
}
...
#footer .abonnement {
	...
	width: 673px;
	height: 155px;
	background: url('/medias/web/img/elements_lm/footer_supports.jpg')
...
#footer .zone_abo {
	...
	width: 673px;
	height: 155px;
	background: url('/medias/web/img/elements_lm/footer_supports_haut.png')
		no-repeat 385px top;
}
...
#footer .abonnement .contenu {
	...
	background:
		url('/medias/web/img/elements_lm/le_monde_abonements_227x22.png')
		no-repeat 13px top;
	color: #16212c;
	line-height: 120%;
}
...
#footer .deja_abonne {
	...
	margin: 25px 0 0;
	background: #fafbfc
		url('/medias/web/img/elements_lm/footer_deja_abo.jpg') no-repeat right
		top;
}
...
#footer .footer_listes a, #footer .footer_listes span, #footer .footer_bas a,
	#footer .footer_bas span, #footer .footer_listes li {
	color: #a2a9ae;
}
...
.conteneur_popinbox {
	...
	background: transparent
		url('/medias/web/img/habillage/lightbox_sociaux_coche.png') no-repeat
		center top;
	display: none;
}
...
.col_droite .position_pub.filled {
	...
	background: #e9edf0
		url('/medias/web/img/textes/marqueur_pub_col_droite.png') no-repeat
		bottom right;
}
...
.carrousel .elt {
    ...
    */
	width: 644px;
	float: left;
	/* il faudra gerer en surchargeant les slideshow verticaux*/
	position: relative;
}
...
.conteneur_carrousel .navigation .precedent span, .conteneur_carrousel .navigation .suivant span,
	.conteneur_carrousel .navigation .reperes, .conteneur_carrousel .navigation .repere
	{
	display: inline-block;
	vertical-align: middle;
 ...
 */
/**********************************************/
.portfolio_appel_revolutionnaire.conteneur_carrousel .navigation .reperes,
	.portfolio_appel_revolutionnaire .portfolio_data_container h2 {
...
.portfolio_appel_revolutionnaire.conteneur_carrousel .navigation .precedent,
...
.portfolio_appel_revolutionnaire.conteneur_carrousel .navigation .precedent:hover,
	.portfolio_appel_revolutionnaire.conteneur_carrousel .navigation .suivant:hover
	{
	cursor: pointer;
}

.portfolio_appel_revolutionnaire.conteneur_carrousel .navigation .precedent span,
	...
	background: -webkit-gradient(linear, left center, right center, color-stop(0%, #eee),
		color-stop(50%, #fff), color-stop(100%, #fff));
...
.portfolio_appel_revolutionnaire.conteneur_carrousel .navigation .suivant span
	...
	background: -webkit-gradient(linear, left center, right center, color-stop(0%, #fff),
		color-stop(55%, #fff), color-stop(100%, #eee));
...
.portfolio_appel_revolutionnaire.conteneur_carrousel .navigation .precedent:hover span,
	.portfolio_appel_revolutionnaire.conteneur_carrousel .navigation .suivant:hover span
	{
...
#surheader, #surheader .conteneur_haut {
	...
	background: -webkit-gradient(linear, left top, left bottom, color-stop(0%, #1e5799),
		color-stop(0%, #2d3841), color-stop(100%, #010c16));
	/* Chrome,Safari4+ */
	...
	/* W3C */
	filter: progid:DXImageTransform.Microsoft.gradient( startColorstr='#2d3841',
		endColorstr='#010c16', GradientType=0); /* IE6-9 */
	height: 25px;
	line-height: 25px;
}
...
.sociaux .obf, .sociaux .obf strong, .sociaux .obf span, .sociaux .obf:hover strong,
	.sociaux .obf:hover span, .sociaux .obf:focus strong, .sociaux .obf:focus span
	{
	color: #000;
	text-decoration: none;
}
...
#header .acces_compte .fle {
	width: 28px;
	background: url('/medias/web/img/pictos/fle_bas_noir7x4.png') no-repeat
		50% 50%;
}
...
.filtre_page {
	...
	height: 100%;
	z-index: 15;
	/* ce z-index est infatue a cause des exports partenaires */
	left: 0;
	top: 0;
...
.loginbox .abonne_journal {
	...
	font-size: 14px;
	line-height: 140%;
	background: url('/medias/web/img/elements_lm/login_box_journal.jpg')
		no-repeat right 130px;
	border-left: 1px solid #e4e6e9;
}
...
#barre_titre #logo {
	...
	background: url('/medias/web/img/elements_lm/logo_lm240x42.png')
		no-repeat;
	font-size: 46px;
	text-indent: -9999px;
}
...
.ombrelle .tt_rubrique_ombrelle, .ombrelle.style .tt_rubrique_ombrelle {
	...
	padding: 0 0 0 67px;
	margin: 25px 0 0;
	background: url('/medias/web/img/elements_lm/m54x44.png') no-repeat 0
		20%;
	font-family: 'TheSerifOffice', georgia, serif;
	font-size: 55px;
	line-height: 55px;
...
.ombrelle .tt_rubrique_ombrelle a, .ombrelle .tt_rubrique_ombrelle h2 a:hover,
	.ombrelle .tt_rubrique_ombrelle .obf, .ombrelle .tt_rubrique_ombrelle .obf:hover
	{
	color: #2E3942;
	text-decoration: none;
}
...
.ombrelle.style .tt_rubrique_ombrelle {
	background: url('/medias/web/img/elements_lm/m59x44.png') no-repeat 0
		20%;
}

.ombrelle .tt_rubrique_ombrelle.max24, .ombrelle .tt_rubrique_ombrelle.max32,
...
#nav_ariane {
	height: 35px;
	overflow: hidden;
	background: url('/medias/web/img/sprites/sous_nav.png') repeat left
		-630px;
}
...
#ariane_az #sn .navlist li a:hover, #ariane_az #sn .navlist li a:focus,
	#ariane_az #sn .navlist li a:hover span, #ariane_az #sn .navlist li a:focus span,
	#ariane_az #sn .navlist .cur a span {
	background: none;
	color: #6faa12;
}
...
.liste_reactions  .bulle {
	...
	width: 170px;
	padding: 11px 0 0;
	background: url('/medias/web/img/habillage/lightbox_sociaux_coche.png')
...
.reaction_identifier .non_abo, .conteneur_barre_outils .non_abo.classer
	...
	height: 230px;
	padding: 10px 10px 10px 14px;
	background: url('/medias/web/img/textes/daccord_pas_daccord.png')
		no-repeat 16px 40px;
	border-right: 1px solid #fff;
}
...
.conteneur_barre_outils  .non_abo.classer {
	background: url('/medias/web/img/textes/pas_le_temps_lire.png')
		no-repeat 16px 40px;
}
...
.services .bloc_part.gymglish.grid_12, .services .bloc_part.darqroom.grid_12.promo
	...
	background-image: -webkit-gradient(linear, 0 0, 0 100%, from(#fafbfc),
		to(#e9ecf0));
...
.bloc_part.empruntis  .contenu {
	padding: 0 15px 0;
	background: url('/medias/web/img/partenaires/empruntis/stylo.jpg')
		no-repeat;
}
...
.col_droite .twtr-widget .twtr-join-conv:hover, .col_droite .twtr-widget .twtr-join-conv:focus,
	.col_droite.twtr-widget .twtr-join-conv:active {
...
.col_droite .recherche_resultat_pres.bloc_base {
	background: #0b0423
		url('/medias/web/img/evenementiel/presidentielle_2012/bg_recherche_elections_col_droite.png')
		center 0 no-repeat;
	color: #fff;
}
...
.col_droite .recherche_resultat_pres .entete span {
	...
	height: 30px;
	background:
		url('/medias/web/img/textes/elections/bulle_2012_39x27_bg_fonce.png')
		no-repeat;
	padding-left: 50px;
}
...
.bloc_je .tt_dossier_meilleur_monde {
	background: url('/medias/www/img/tit/tt_dossiers_meilleur_monde.png')
...
.bloc_couvs b {
	...
	width: 280px;
	height: 44px;
	background: url('/medias/www/img/plus_une_lemonde.png') left center
		no-repeat;
	position: relative;
}
...
.bloc_couvs.bloc_2_couv b {
	...
	width: 15px;
	height: 15px;
	background: url('/medias/www/img/plus_une_lemonde.png') right center
		no-repeat;
	position: absolute;
}
...
.conteneur_lives .live .bandeau {
	...
	background-image: -webkit-gradient(linear, 0 0, 0 100%, from(#d20303),
		to(#bf0202));
	...
	background-repeat: repeat-x;
	filter: progid:DXImageTransform.Microsoft.gradient(startColorstr='#d20303',
		endColorstr='#bf0202', GradientType=0);
}
...
.conteneur_lives .lives .chrome {
	background: #d50303 url('/medias/web/img/textes/tt_live_bas.png')
		no-repeat;
	height: 25px;
	line-height: 23px;
...
/*** pictos bandeau live ***/
.conteneur_lives .live .bandeau .voir, .conteneur_lives .lives .chrome .live_replier,
	.conteneur_lives .lives .chrome .popup, .conteneur_lives .lives .chrome .live_deplier,
	.conteneur_lives .lives .chrome .live_fermer {
...
.conteneur_lives .lives.grand .chrome .live_replier:hover,
	.conteneur_lives .lives.grand  .chrome .popup:hover, .conteneur_lives .lives.grand  .chrome .live_deplier:hover,
	.conteneur_lives .lives.grand   .chrome .live_fermer:hover {
	opacity: 1;
}
...
.global.fonce a:hover, .global.fonce span:hover, .global.fonce .obf:hover,
	.global.fonce a:hover .tt17 {
	color: #a2a9ae;
}
...
.international #ariane_az  a:hover, .international  #ariane_az .obf:hover,
	.ombrelle.international .tt_rubrique_ombrelle, .ombrelle.international h2 .obf,
	.ombrelle.international h2 .obf:hover, .international .tt_rubrique,
	.international .jour_parution, .international .couleur_rubrique {
	color: #0386c3; /*couleur foncee*/
}
...
.politique #ariane_az  a:hover, .politique  #ariane_az .obf:hover,
	.ombrelle.politique .tt_rubrique_ombrelle, .ombrelle.politique h2 .obf,
	.ombrelle.politique h2 .obf:hover, .politique .tt_rubrique, .politique .couleur_rubrique
	{
	color: #1f0d67;
}
/* societe */
...
.societe  #ariane_az  a:hover, .societe   #ariane_az .obf:hover,
	.ombrelle.societe .tt_rubrique_ombrelle, .ombrelle.societe h2 .obf,
	.ombrelle.societe h2 .obf:hover, .societe .tt_rubrique, .societe .jour_parution,
	.societe .couleur_rubrique {
	color: #d50303;
}
...
.economie  #ariane_az  a:hover, .economie   #ariane_az .obf:hover,
	.ombrelle.economie .tt_rubrique_ombrelle, .ombrelle.economie h2 .obf,
	.ombrelle.economie h2 .obf:hover, .economie .tt_rubrique, .economie .jour_parution,
	.economie .couleur_rubrique {
	color: #fe2f2f;
}
...
.culture  #ariane_az  a:hover, .culture  #ariane_az .obf:hover,
	.ombrelle.culture .tt_rubrique_ombrelle, .ombrelle.culture h2 .obf,
	.ombrelle.culture h2 .obf:hover, .culture .tt_rubrique, .culture .jour_parution,
	.culture .couleur_rubrique {
	color: #f20559;
}
...
#ariane_az  a:hover, #ariane_az .obf:hover, .ombrelle .tt_rubrique_ombrelle,
	.ombrelle h2 .obf, .ombrelle h2 .obf:hover, .tt_rubrique,
	.jour_parution, .couleur_rubrique {
	color: #2e3942;
}
...
.education   #ariane_az  a:hover, .education  #ariane_az .obf:hover,
	.ombrelle.education .tt_rubrique_ombrelle, .ombrelle.education h2 .obf,
	.ombrelle.education h2 .obf:hover, .education .tt_rubrique, .education .jour_parution,
	.education .couleur_rubrique {
	color: #ff6e17;
}
...
.planete   #ariane_az  a:hover, .planete  #ariane_az .obf:hover,
	.ombrelle.planete .tt_rubrique_ombrelle, .ombrelle.planete h2 .obf,
	.ombrelle.planete h2 .obf:hover, .planete .tt_rubrique, .planete .jour_parution,
	.planete .couleur_rubrique {
	color: #30932e;
}
...
.sante   #ariane_az  a:hover, .sante  #ariane_az .obf:hover, .ombrelle.sante .tt_rubrique_ombrelle,
	.ombrelle.sante h2 .obf, .ombrelle.sante h2 .obf:hover, .sante .tt_rubrique,
	.sante .jour_parution, .sante .couleur_rubrique {
	color: #189494;
}
...
.sport  #ariane_az  a:hover, .sport  #ariane_az .obf:hover, .ombrelle.sport .tt_rubrique_ombrelle,
	.ombrelle.sport h2 .obf, .ombrelle.sport h2 .obf:hover, .sport .tt_rubrique,
	.sport .jour_parution, .sport .couleur_rubrique {
	color: #6faa12;
}
...
.sciences  #ariane_az  a:hover, .sciences   #ariane_az .obf:hover,
	.ombrelle.sciences .tt_rubrique_ombrelle, .ombrelle.sciences h2 .obf,
	.ombrelle.sciences h2 .obf:hover, .sciences .tt_rubrique, .sciences .jour_parution,
...
.techno  #ariane_az  a:hover, .techno  #ariane_az .obf:hover, .ombrelle.techno .tt_rubrique_ombrelle,
	.ombrelle.techno h2 .obf, .ombrelle.techno h2 .obf:hover, .techno .tt_rubrique,
	.techno .jour_parution, .techno .couleur_rubrique {
	color: #006169;
}
...
.ombrelle.style .tt_rubrique_ombrelle, .ombrelle.style h2 .obf,
	.ombrelle.style h2 .obf:hover, .style .tt_rubrique, .style .jour_parution,
	.style .couleur_rubrique {
	color: #020818;
}
...
.vous  #ariane_az  a:hover, .vous  #ariane_az .obf:hover, .ombrelle.vous .tt_rubrique_ombrelle,
	.ombrelle.vous h2 .obf, .ombrelle.vous h2 .obf:hover, .vous .tt_rubrique,
	.vous .jour_parution, .vous .couleur_rubrique {
	color: #820250;
}
...
.abonnes  #ariane_az  a:hover, .abonnes  #ariane_az .obf:hover,
	.ombrelle.abonnes .tt_rubrique_ombrelle, .ombrelle.abonnes h2 .obf,
	.ombrelle.abonnes h2 .obf:hover, .abonnes .tt_rubrique, .abonnes .jour_parution,
	.abonnes .couleur_rubrique {
	color: #ffd500;
}

/* surcharge de la couleur du bouton actif du fil d'ariane */
#ariane_az .ariane a:hover, #ariane_az .ariane .obf:hover, #nav_ariane .ariane.actif a,
	#nav_ariane .ariane.actif span {
	color: #fff;
}
...
.global.presidentielle .entete_deroule, .global.presidentielle .entete_deroule:hover
	{
	background:
		url('/medias/web/img/textes/elections/bandeau_deroule_presidentielles2012.png')
		no-repeat;
	text-indent: -9999px;
}
...
.deroule_fleuve .logo_annee_france {
	...
	background: url('/medias/web/img/habillage/logo_annee_france.png')
		no-repeat left top;
}
...
.deroule_fleuve .carte_annee_france {
	...
	height: 226px;
	margin-bottom: 15px;
	background: url('/medias/web/img/habillage/carte_annee_france.jpg')
		no-repeat right top;
}
...
.col_droite .alerte_election {
	...
	height: 48px;
	background:
		url('/medias/web/img/textes/elections/tetiere-bloc-formulaire-alerte.png');
	text-indent: -9999px;
}
...
.boite_recherche {
	background: #f8f9fb
		url('/medias/web/img/evenementiel/presidentielle_2012/bg_recherche_elections.png')
		center 0 no-repeat;
	overflow: visible;
...
.lien_img314x64.comparer_sondages {
	background:
		url('/medias/web/img/textes/elections/widget_comparer_sondages.png');
	text-indent: -9999px;
}

.lien_img314x64.comparer_programmes {
	background:
		url('/medias/web/img/textes/elections/widget_comparateur2nd_tour.png');
	text-indent: -9999px;
}

.lien_img314x64.inscription_alerte {
	background:
		url('/medias/web/img/textes/elections/widget_inscription_alerte.jpg');
	text-indent: -9999px;
}

.lien_img314x64.explorer_discours_2012 {
	background:
		url('/medias/web/img/textes/elections/widget_explorer_discours_2012.png');
	text-indent: -9999px;
}
...
#header-liberation .header-base .home, #header-liberation .header-base .sites-info-search,
	#header-liberation .header-base .links, #header-liberation .header-base .digitalpaper
	{
	display: block;
	float: left;
}
...
#header-liberation .header-base .sites-info-search ul.sites li span.logo
	...
	position: absolute;
	background-image:
		url('http://s0.libe.com/libe/img/common/_sprites_header/header.png?df8de01457fa');
	background-repeat: no-repeat;
}
...
.lnk-libeplus {
	background-image:
		url('http://s0.libe.com/libe/img/common/ico-lnk-libeplus.png?2967b1507eee');
	background-repeat: no-repeat;
...
.lnk-libeplus-big {
	background-image:
		url('http://s0.libe.com/libe/img/common/ico-lnk-libeplus-big.png?401394d0f866');
	background-repeat: no-repeat;
	background-position: right 4px;
	padding-right: 30px;
}
...
.site-liberation .hot-topics h5 {
	...
	background:
		url('http://s0.libe.com/libe/img/common/bg-puce-losange.png?099dfb8021ab')
...
#header-liberation .header-base .home .logo {
	background:
		url('http://s0.libe.com/libe/img/common/logo-liberation-150.png?f613aa3caae2')
		no-repeat 0 0;
	width: 150px;
	height: 55px;
	margin-top: 33px;
...
#footer-liberation .abo, #footer-liberation .monlibe, #footer-liberation .news,
...
#footer-liberation .monlibe, #footer-liberation .news,
	#footer-liberation .services {
	min-height: 200px
}
...
#footer-liberation .monlibe h5, #footer-liberation .news h5,
...
#core-liberation .text-static h2, #core-liberation .text-static h3,
...
#core-liberation .text-https h2, #core-liberation .text-https h3,
...
#core-liberation form input[type=text]:focus, #core-liberation form input[type=password]:focus,
	#core-liberation form input[type=file]:focus, #core-liberation form textarea:focus,
	#core-liberation form select, #core-liberation form checkbox {
	outline: 1px solid
}
...
#core-liberation .form-monlibe input[type=text], #core-liberation .form-monlibe input[type=password],
...
#core-liberation ul.list-items li h5, #core-liberation ul.list-items li h4,
...
#core-liberation ul.list-items li.full h5, #core-liberation ul.list-items li.full h4,
...
#core-liberation ul.list-items li.full h5, #core-liberation ul.list-items li.half h4,
...
#core-liberation ul.list-items li.arround h5, #core-liberation ul.list-items li.arround h4,
...
.col-part .block .follow-libe .fb, .col-part .block .follow-libe .twitter,
	.col-part .block .follow-libe .nv-rss {
	padding-top: 7px
}

.col-part .block .follow-libe .fb p, .col-part .block .follow-libe .twitter p,
...
.col-part .block .follow-libe .nv-rss a.rss {
	background:
		url('http://s0.libe.com/libe/img/common/ico-rss.jpg?e5d7b4c9c034')
		no-repeat 0 1px
}

.col-part .block .follow-libe .nv-rss a.nv {
	background:
		url('http://s0.libe.com/libe/img/common/ico-netvibes.jpg?f74e57884286')
		no-repeat 0 1px;
	padding-right: 3px;
}
...
#core-liberation .block-item-locked h2, #core-liberation .block-item-locked h3,
...
#core-liberation .block-comments .block-content .comment_selected>.comment_outer .icon
	...
	height: 25px;
	background:
		url('http://s0.libe.com/libe/img/common/_sprites_icons/icons.png?9914d0d70a49')
		no-repeat -59px -36px;
}
...
#core-liberation .block-comments .block-content .comment_draft>.comment_outer
	{
	background-image:
		url('http://s0.libe.com/libe/img/common/bg-comment-draft.png?4158f727c626')
}
...
#bar-liberation .god a.godenter {
	background:
		url('http://s0.libe.com/libe/img/common/icon_godenter.png?9ffa63824b5c')
		no-repeat center center #fff
}

#bar-liberation .god a.godquit {
	background:
		url('http://s0.libe.com/libe/img/common/icon_godquit.png?a59104f30cfb')
...
#bar-liberation .god a.godquit:hover {
	background:
		url('http://s0.libe.com/libe/img/common/icon_godenter.png?9ffa63824b5c')
		no-repeat center center yellow
}

#bar-liberation .god a.jumptoadmin {
	background:
		url('http://s0.libe.com/back/img/icon_home.png?c1de55b52ccc')
		no-repeat center center #fff
}

#bar-liberation .god a.jumptoedit {
	background:
		url('http://s0.libe.com/back/img/icon_changelink.png?4a31d309d5db')
		no-repeat center center #fff
}
...
#core-liberation .block-partnership .block-content ul li a,
	...
	background:
		url('http://s0.libe.com/libe/img/common/ico-lnk-arrow-red.gif?feba6ff926a7')
		no-repeat 0 4px;
	padding-left: 15px;
}
...
#core-liberation .block-podcast .block-content p.logo-pc {
	background:
		url('http://s0.libe.com/libe/img/common/bg-podcast.png?bc9501afa40e')
...
#core-liberation .block-search-head form input[type=submit],
	...
	background-image:
		url('http://s0.libe.com/libe/img/common/bg-search-formsubmit.png?96b143873213');
	background-repeat: repeat-x;
	background-position: 0 0;
	border-style: solid;
	border-width: 1px;
...
#core-liberation .block-search-head form input[type=submit]:hover {
	background-image:
		url('http://s0.libe.com/libe/img/common/bg-search-formsubmit-on.png?21388ca68b89')
}

#core-liberation .block-search-results form input[type=submit]:active {
	background-image:
		url('http://s0.libe.com/libe/img/common/bg-search-formsubmit-active.png?16bd2d8fbc96')
}
...
#core-liberation .block-search-head .advanced .note a.displayer {
	...
	font-weight: bold;
	background-image:
		url('http://s0.libe.com/libe/img/common/bg-search-down.png?b74f495d5e6b');
	background-repeat: no-repeat;
...
#core-liberation .block-search-head .displayed .note a.displayer {
	background-image:
		url('http://s0.libe.com/libe/img/common/bg-search-up.png?6f25843d1bc2')
}
...
#core-liberation .headrest h5, #core-liberation .headrest h4,
...
#core-liberation .headrest .folder {
	background:
		url('http://s0.libe.com/libe/img/common/bg-headrest-triangle.png?589ad9ce9011')
...
#core-liberation .cartridge a.btn-comment-disabled {
	background: transparent
		url('http://s0.libe.com/libe/img/common/bg-btn-comment.png?593ec6d1f747')
}
...
form .btn-basic input[type=button], form .btn-basic input[type=submit],
...
.btn-laune span, .btn-laune a, .btn-monlibe span, .btn-monlibe a,
	.btn-zoneabo span, .btn-zoneabo a {
	display: block;
	padding: 5px 5px 7px;
	border-radius: 5px 5px 5px 5px;
	-moz-border-radius: 5px 5px 5px 5px;
...
form .btn-laune input[type=button], form .btn-laune input[type=submit],
	form .btn-laune input[type=reset], form .btn-monlibe input[type=button],
	form .btn-monlibe input[type=submit], form .btn-monlibe input[type=reset],
	form .btn-zoneabo input[type=button], form .btn-zoneabo input[type=submit],
...
form .btn-rounded-degraded input[type=button]:hover, form .btn-rounded-degraded input[type=submit]:hover,
	form .btn-rounded-degraded input[type=button]:focus, form .btn-rounded-degraded input[type=submit]:focus
	{
	text-decoration: none
}
...
.btn-read-digitalpaper span, .btn-read-digitalpaper a {
	...
	min-height: 32px;
	background:
		url('http://s0.libe.com/libe/img/common/reader_picto.png?8fdcc4850538')
		no-repeat right top;
	padding-right: 50px;
	font-size: 12px;
}
...
#core-liberation .pagination .first {
	float: left;
	background-image:
		url('http://s0.libe.com/libe/img/common/bg-search-pagination-first.png?71b3279ad5d6');
	background-repeat: no-repeat;
...
#core-liberation .pagination .prev {
	float: left;
	background-image:
		url('http://s0.libe.com/libe/img/common/bg-search-pagination-prev.png?0ae4b5772718');
	background-repeat: no-repeat;
...
#core-liberation .pagination .next {
	float: right;
	background-image:
		url('http://s0.libe.com/libe/img/common/bg-search-pagination-next.png?363861606f55');
	background-repeat: no-repeat;
...
#core-liberation .block .pager ul.circle li a {
	...
	height: 7px;
	background-image:
		url('http://s0.libe.com/libe/img/common/btn-circle-off.gif?36d3bb5f1d80');
	background-repeat: no-repeat;
}

#core-liberation .block .pager ul.circle li a.on {
	background-image:
		url('http://s0.libe.com/libe/img/common/btn-circle-on.gif?c66d45940adc')
}
...
#core-liberation .bg-sprites-icons a.twitter, #core-liberation .bg-sprites-icons a.facebook,
	#core-liberation .bg-sprites-icons a.mail, #core-liberation .bg-sprites-icons a.star
	{
	display: block;
	background-image:
		url('http://s0.libe.com/libe/img/common/_sprites_icons/icons.png?9914d0d70a49');
...
.site-liberation .toolbox .txt-min:hover, .site-liberation .toolbox .txt-plus:hover,
	.site-liberation .toolbox .txt-reset:hover, .site-liberation .toolbox .comment:hover,
	.site-liberation .toolbox .facebook:hover, .site-liberation .toolbox .twitter
	{
	text-decoration: none
}
...
#core-liberation .sb-podcasts ul li a {
	display: block;
	background-image:
		url('http://s0.libe.com/libe/img/common/_sprites_podcasts/podcasts.png?6e3b93dc1f3c');
	background-repeat: no-repeat;
	height: 17px;
}
...
#bar-liberation .content .close, #bar-liberation .content .open,
	#bar-liberation .content .login, #bar-liberation .content .personal-options,
	#bar-liberation .content .mail-box, #bar-liberation .content .activities-stream,
...
#bar-liberation .content a.displayer .arrow {
	background:
		url('http://s0.libe.com/libe/img/common/_sprites_header/triangle_ferme.png?1ecaa0c231c9')
		no-repeat 0 0;
	display: block;
	position: absolute;
	right: 10px;
...
#bar-liberation .content a.displayer:hover .arrow {
	background:
		url('http://s0.libe.com/libe/img/common/_sprites_header/triangle_ferme_grey.png?a9a52344ba82')
		no-repeat 0 0
}

#bar-liberation .content a.displayer .arrow-displayed {
	background:
		url('http://s0.libe.com/libe/img/common/_sprites_header/triangle_ouvert.png?c782eb482038')
		no-repeat 1px 1px
}
...
#core-liberation .block-activities .block-content ul li a,
	#bar-liberation .content ul.list li a, #core-liberation .block-activities .block-content ul li a:hover,
...
.site-liberation a:hover, .site-liberation a:hover p, .site-liberation a:hover h6,
	.site-liberation a:hover h5, .site-liberation a:hover h4,
	.site-liberation a:hover h3, .site-liberation a:hover h2 {
	text-decoration: underline
}

.site-liberation .lnk-comments {
	background:
		url('http://s0.libe.com/libe/img/common/ico-lnk-comment.png?48525c2557e6')
		no-repeat left 2px;
	padding-left: 20px;
	font-size: 10px;
	line-height: 15px;
...
.site-liberation .block-call-items .mini-tpl h2.lnk-libeplus:after,
	...
	margin-left: 10px;
	background:
		url('http://s0.libe.com/libe/img/common/ico-lnk-libeplus-big2.png?d4d49ea9ef21')
		no-repeat 0 0;
}
...
.site-liberation .block-call-items .mini-tpl h5.lnk-libeplus:after,
	...
	margin-left: 5px;
	background:
		url('http://s0.libe.com/libe/img/common/ico-lnk-libeplus2.png?39fe048f4782')
		no-repeat 0 0;
}
...
.site-liberation .block-call-items .mini-tpl .label {
	background:
		url('http://s0.libe.com/libe/img/common/bg-separateur.gif?e78a16835c55')
		no-repeat right center;
	border: 2px solid;
	min-height: 45px;
}
...
.site-liberation .block-call-items .mini-tpl .whosaid a.zap {
	...
	height: 21px;
	background:
		url('http://s0.libe.com/libe/img/common/btn_shaker.gif?6340e450364b')
		no-repeat 0 0;
	bottom: 14px;
	right: 14px;
}
...
.site-liberation .block-call-items .tpl-labo-spotlight .subscribe p.toggle a
	{
	background:
		url('http://s0.libe.com/libe/img/common/pi_arrow-down.gif?83c2b5fdcd15')
		no-repeat 0 5px;
	padding-left: 15px;
}
...
body.barry-white {
	background: #f8f8f8
		url('http://s0.libe.com/libe/img/common/bg-body-fff.gif?62ad83bcadf5')
		repeat-y center 0
}
...
#header-liberation .header-base .nav .on .nav1 a, #header-liberation .header-base .nav-no-js>li:hover .nav1 a,
	#header-liberation .header-base .nav .nav1 a:hover {
	color: #fff
}
...
#header-liberation .header-simple .header {
	background:
		url('http://s0.libe.com/libe/img/common/bg-e20000.png?020f61e6035c')
		repeat-x 0 39px
}
...
#header-liberation .header-simple .back a {
	color: #858585;
	background:
		url('http://s0.libe.com/libe/img/common/ico-lnk-arrow-back-grey.png?c8d5a4458a2c')
		no-repeat 0 16px;
}
...
#core-liberation .block-item-locked {
	...
	background: -webkit-gradient(linear, left top, left bottom, color-stop(0%, #dbdad6),
		color-stop(2%, #fff), color-stop(98%, #fff), color-stop(100%, #e1e0de));
...
#core-liberation .headrest-community h3, #core-liberation .headrest-community a.lnk-back,
	#core-liberation .headrest-community a.lnk-com {
	color: #555
}
...
.site-liberation .btn-basic span, .site-liberation .btn-basic a,
	.site-liberation form .btn-basic input[type=button], .site-liberation form .btn-basic input[type=submit],
	...
	background: -webkit-gradient(linear, left top, left bottom, color-stop(0%, #f2f2f2),
		color-stop(50%, #f2f2f2), color-stop(51%, #ccc),
		color-stop(100%, #ccc));
...
.site-liberation .btn-laune a:hover, .site-liberation .btn-monlibe a:hover,
...
.site-liberation form .btn-laune input[type=button], .site-liberation form .btn-laune input[type=submit],
	.site-liberation form .btn-laune input[type=reset], .site-liberation form .btn-monlibe input[type=button],
	.site-liberation form .btn-monlibe input[type=submit], .site-liberation form .btn-monlibe input[type=reset],
	.site-liberation form .btn-zoneabo input[type=button], .site-liberation form .btn-zoneabo input[type=submit],
...
.site-liberation form .btn-monlibe input[type=button], .site-liberation form .btn-monlibe input[type=submit],
...
.site-liberation .btn-rounded-degraded span, .site-liberation .btn-rounded-degraded a
	...
	background: -webkit-gradient(linear, left top, left bottom, color-stop(0%, #f33333),
		color-stop(100%, #b33));
...
.site-liberation .btn-rounded-degraded span:hover, .site-liberation .btn-rounded-degraded a:hover
	...
	background: -webkit-gradient(linear, left top, left bottom, color-stop(0%, #b33),
		color-stop(100%, #f33333));
...
.site-liberation .bg-sprites-icons .folder1, .site-liberation .bg-sprites-icons .folder1-black,
...
.site-liberation .bg-sprites-icons .close1, .site-liberation .bg-sprites-icons .close1-black,
...
.site-liberation .bg-sprites-icons .edit1, .site-liberation .bg-sprites-icons .edit1-black,
...
.site-liberation .bg-sprites-icons .heart1, .site-liberation .bg-sprites-icons .heart1-laune,
...
.site-liberation .toolbox .txt-min, .site-liberation .toolbox .txt-plus,
	.site-liberation .toolbox .txt-reset, .site-liberation .toolbox .comment,
	.site-liberation .toolbox .facebook, .site-liberation .toolbox .twitter
	{
	color: #818181
}
...
.site-liberation .toolbox li a.facebook span {
	background:
		url('http://s0.libe.com/libe/img/common/_sprites_icons/icons_share.png?edeb5617b880')
		no-repeat -74px 0
}
...
#core-liberation .block-activities .block-content ul li,
	#core-liberation .block-activities .block-content ul li a,
	#bar-liberation .content ul.list li, #bar-liberation .content ul.list li a
	{
	color: #222
}
...
#page-paywall .content .banner-degraded {
	...
	background: -webkit-gradient(linear, left top, left bottom, color-stop(0%, #dbdad6),
		color-stop(10%, #fff), color-stop(90%, #fff),
		color-stop(100%, #e1e0de));
