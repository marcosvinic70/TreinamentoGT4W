...
@font-face {
	...
	src: local(Futura-Medium),
		url(https://www.github.com/cloudhead/less.js/fonts.svg#MyGeometricModern)
		format("svg");
}
...
#misc {
	background-image:
		url(https://www.github.com/cloudhead/less.js/images/image.jpg);
}
...
.comma-delimited {
	background: url(https://www.github.com/cloudhead/less.js/bg.jpg)
		no-repeat, url(https://www.github.com/cloudhead/less.js/bg.png)
		repeat-x top left, url(https://www.github.com/cloudhead/less.js/bg);
}
