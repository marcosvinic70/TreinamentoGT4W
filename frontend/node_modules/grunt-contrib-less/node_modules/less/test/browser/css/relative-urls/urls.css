...
@font-face {
	...
	src: local(Futura-Medium),
		url(http://localhost:8081/browser/less/relative-urls/fonts.svg#MyGeometricModern)
		format("svg");
}
...
#misc {
	background-image:
		url(http://localhost:8081/browser/less/relative-urls/images/image.jpg);
}
...
.comma-delimited {
	background: url(http://localhost:8081/browser/less/relative-urls/bg.jpg)
		no-repeat,
		url(http://localhost:8081/browser/less/relative-urls/bg.png) repeat-x
		top left, url(http://localhost:8081/browser/less/relative-urls/bg);
}
