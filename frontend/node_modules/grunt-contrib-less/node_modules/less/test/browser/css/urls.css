...
@font-face {
	...
	src: local(Futura-Medium),
		url(http://localhost:8081/browser/less/fonts.svg#MyGeometricModern)
		format("svg");
}
...
#misc {
	background-image:
		url(http://localhost:8081/browser/less/images/image.jpg);
}
...
.comma-delimited {
	background: url(http://localhost:8081/browser/less/bg.jpg) no-repeat,
		url(http://localhost:8081/browser/less/bg.png) repeat-x top left,
		url(http://localhost:8081/browser/less/bg);
}
...
#data-uri-toobig {
	uri:
		url('http://localhost:8081/browser/less/../../data/data-uri-fail.png');
}