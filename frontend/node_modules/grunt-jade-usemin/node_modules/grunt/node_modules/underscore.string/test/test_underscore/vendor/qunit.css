...
#qunit-tests, #qunit-header, .qunit-header, #qunit-banner,
	#qunit-testrunner-toolbar, #qunit-userAgent, #qunit-testresult {
...
/** Resets */
#qunit-tests, #qunit-tests ol, #qunit-header, #qunit-banner,
