...
div.coverage-summary .yui3-datatable-sort-indicator {
	background:
		url("https://yui-s.yahooapis.com/3.6.0/build/datatable-sort/assets/skins/sam/sort-arrow-sprite.png")
...
<body>
	<div class="header low">
		<h1>
			Code coverage report for <span class="entity">spec/helpers.js</span>
		</h1>
		<h2>

			Statements: <span class="metric">19.23% <small>(70 /
					364)</small></span> &nbsp;&nbsp;&nbsp;&nbsp; Branches: <span class="metric">0%
				<small>(0 / 26)</small>
			</span> &nbsp;&nbsp;&nbsp;&nbsp; Functions: <span class="metric">7.81%
				<small>(10 / 128)</small>
			</span> &nbsp;&nbsp;&nbsp;&nbsp; Lines: <span class="metric">20.71% <small>(70
					/ 338)</small></span> &nbsp;&nbsp;&nbsp;&nbsp; Ignored: <span class="metric"><span
				class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
		</h2>
		<div class="path">
			<a href="../index.html">All files</a> &#187; <a href="index.html">spec/</a>
			&#187; helpers.js
		</div>
	</div>
	<div class="body">
...
<span class="cline-any cline-neutral">&nbsp;</span></td>
					<td class="text"><pre class="prettyprint lang-js">/*global CompilerContext, Handlebars, shouldCompileTo, shouldCompileToWithPartials, shouldThrow, handlebarsEnv */
describe('helpers', function() {
  it("helper with complex lookup$", <span class="fstat-no"
...
<span class="cstat-no" title="statement not covered">    var helpers = {link: <span
								class="fstat-no" title="function not covered">function(prefix) {</span></span>
...
&nbsp;
  it("helper for raw block gets raw content", <span class="fstat-no"
								title="function not covered">function() {</span>
...
<span class="cstat-no" title="statement not covered">    var helpers = { raw: <span
								class="fstat-no" title="function not covered">function(options) {</span></span>
...
<span class="cstat-no" title="statement not covered">    shouldCompileTo(string, [hash, helpers], " {{test}} ",</span>
  ...
  it("helper for raw block gets parameters", <span class="fstat-no"
								title="function not covered">function() {</span>
<span class="cstat-no" title="statement not covered">    var string   = "{{{{raw 1 2 3}}}} {{test}} {{{{/raw}}}}";</span>
<span class="cstat-no" title="statement not covered">    var hash = { test: "hello" };</span>
<span class="cstat-no" title="statement not covered">    var helpers = { raw: <span
								class="fstat-no" title="function not covered">function(a, b, c, options) {</span></span>
...
<span class="cstat-no" title="statement not covered">    shouldCompileTo(string, [hash, helpers], " {{test}} 123",</span>
  ...
  it("helper block with complex lookup expression", <span
...
<span class="cstat-no" title="statement not covered">    var helpers = {goodbyes: <span
								class="fstat-no" title="function not covered">function(options) {</span></span>
...
&nbsp;
  it("helper with complex lookup and nested template", <span
								class="fstat-no" title="function not covered">function() {</span>
<span class="cstat-no" title="statement not covered">    var string = "{{#goodbyes}}{{#link ../prefix}}{{text}}{{/link}}{{/goodbyes}}";</span>
<span class="cstat-no" title="statement not covered">    var hash = {prefix: '/root', goodbyes: [{text: "Goodbye", url: "goodbye"}]};</span>
<span class="cstat-no" title="statement not covered">    var helpers = {link: <span
								class="fstat-no" title="function not covered">function (prefix, options) {</span></span>
...
&nbsp;
  it("helper with complex lookup and nested template in VM+Compiler", <span
								class="fstat-no" title="function not covered">function() {</span>
<span class="cstat-no" title="statement not covered">    var string = "{{#goodbyes}}{{#link ../prefix}}{{text}}{{/link}}{{/goodbyes}}";</span>
<span class="cstat-no" title="statement not covered">    var hash = {prefix: '/root', goodbyes: [{text: "Goodbye", url: "goodbye"}]};</span>
<span class="cstat-no" title="statement not covered">    var helpers = {link: <span
...
&nbsp;
<span class="cstat-no" title="statement not covered">    var result = template({world: "world"}, { helpers: {goodbyes: <span
								class="fstat-no" title="function not covered">function(options) {</span> <span
								class="cstat-no" title="statement not covered">return options.fn({text: "GOODBYE"}); </span>}}});</span>
<span class="cstat-no" title="statement not covered">    equal(result, "GOODBYE! cruel world!", "Block helper executed");</span>
  });
&nbsp;
  it("block helper staying in the same context", <span class="fstat-no"
								title="function not covered">function() {</span>
<span class="cstat-no" title="statement not covered">    var string   = "{{#form}}&lt;p&gt;{{name}}&lt;/p&gt;{{/form}}";</span>
<span class="cstat-no" title="statement not covered">    var template = CompilerContext.compile(string);</span>
&nbsp;
<span class="cstat-no" title="statement not covered">    var result = template({name: "Yehuda"}, {helpers: {form: <span
								class="fstat-no" title="function not covered">function(options) {</span> <span
								class="cstat-no" title="statement not covered">return "&lt;form&gt;" + options.fn(this) + "&lt;/form&gt;"; </span>} }});</span>
...
&nbsp;
  it("block helper should have context in this", <span class="fstat-no"
								title="function not covered">function() {</span>
...
&nbsp;
  it("block helper for undefined value", <span class="fstat-no"
								title="function not covered">function() {</span>
<span class="cstat-no" title="statement not covered">    shouldCompileTo("{{#empty}}shouldn't render{{/empty}}", {}, "");</span>
  });
&nbsp;
  it("block helper passing a new context", <span class="fstat-no"
								title="function not covered">function() {</span>
<span class="cstat-no" title="statement not covered">    var string   = "{{#form yehuda}}&lt;p&gt;{{name}}&lt;/p&gt;{{/form}}";</span>
<span class="cstat-no" title="statement not covered">    var template = CompilerContext.compile(string);</span>
&nbsp;
<span class="cstat-no" title="statement not covered">    var result = template({yehuda: {name: "Yehuda"}}, { helpers: {form: <span
								class="fstat-no" title="function not covered">function(context, options) {</span> <span
								class="cstat-no" title="statement not covered">return "&lt;form&gt;" + options.fn(context) + "&lt;/form&gt;"; </span>}}});</span>
<span class="cstat-no" title="statement not covered">    equal(result, "&lt;form&gt;&lt;p&gt;Yehuda&lt;/p&gt;&lt;/form&gt;", "Context variable resolved");</span>
  });
&nbsp;
  it("block helper passing a complex path context", <span
								class="fstat-no" title="function not covered">function() {</span>
<span class="cstat-no" title="statement not covered">    var string   = "{{#form yehuda/cat}}&lt;p&gt;{{name}}&lt;/p&gt;{{/form}}";</span>
<span class="cstat-no" title="statement not covered">    var template = CompilerContext.compile(string);</span>
&nbsp;
<span class="cstat-no" title="statement not covered">    var result = template({yehuda: {name: "Yehuda", cat: {name: "Harold"}}}, { helpers: {form: <span
								class="fstat-no" title="function not covered">function(context, options) {</span> <span
								class="cstat-no" title="statement not covered">return "&lt;form&gt;" + options.fn(context) + "&lt;/form&gt;"; </span>}}});</span>
<span class="cstat-no" title="statement not covered">    equal(result, "&lt;form&gt;&lt;p&gt;Harold&lt;/p&gt;&lt;/form&gt;", "Complex path variable resolved");</span>
  });
&nbsp;
  it("nested block helpers", <span class="fstat-no"
								title="function not covered">function() {</span>
...
<span class="cstat-no" title="statement not covered">    var result = template({</span>
      ...
      helpers: {
        link: <span class="fstat-no" title="function not covered">function(options) {</span> <span
								class="cstat-no" title="statement not covered">return "&lt;a href='" + this.name + "'&gt;" + options.fn(this) + "&lt;/a&gt;"; </span>},
        form: <span class="fstat-no" title="function not covered">function(context, options) {</span> <span
								class="cstat-no" title="statement not covered">return "&lt;form&gt;" + options.fn(context) + "&lt;/form&gt;"; </span>}
      }
    });
...
&nbsp;
  it("block helper inverted sections", <span class="fstat-no"
								title="function not covered">function() {</span>
...
&nbsp;
  it('pathed lambas with parameters', <span class="fstat-no"
								title="function not covered">function() {</span>
...
&nbsp;
  describe("helpers hash", function() {
    it("providing a helpers hash", <span class="fstat-no"
								title="function not covered">function() {</span>
<span class="cstat-no" title="statement not covered">      shouldCompileTo("Goodbye {{cruel}} {{world}}!", [{cruel: "cruel"}, {world: <span
								class="fstat-no" title="function not covered">function() {</span> <span
								class="cstat-no" title="statement not covered">return "world"; </span>}}], "Goodbye cruel world!",</span>
                      "helpers hash is available");
&nbsp;
<span class="cstat-no" title="statement not covered">      shouldCompileTo("Goodbye {{#iter}}{{cruel}} {{world}}{{/iter}}!", [{iter: [{cruel: "cruel"}]}, {world: <span
								class="fstat-no" title="function not covered">function() {</span> <span
								class="cstat-no" title="statement not covered">return "world"; </span>}}],</span>
                      "Goodbye cruel world!", "helpers hash is available inside other blocks");
    });
&nbsp;
    it("in cases of conflict, helpers win", <span class="fstat-no"
								title="function not covered">function() {</span>
<span class="cstat-no" title="statement not covered">      shouldCompileTo("{{{lookup}}}", [{lookup: 'Explicit'}, {lookup: <span
								class="fstat-no" title="function not covered">function() {</span> <span
								class="cstat-no" title="statement not covered">return 'helpers'; </span>}}], "helpers",</span>
...
&nbsp;
    it("the helpers hash is available is nested contexts", <span
								class="fstat-no" title="function not covered">function() {</span>
<span class="cstat-no" title="statement not covered">      shouldCompileTo("{{#outer}}{{#inner}}{{helper}}{{/inner}}{{/outer}}",</span>
                    [{'outer': {'inner': {'unused':[]}}},  {'helper': <span
								class="fstat-no" title="function not covered">function() {</span> <span
								class="cstat-no" title="statement not covered">return 'helper'; </span>}}], "helper",
                    "helpers hash is available in nested contexts.");
    });
&nbsp;
    it("the helper hash should augment the global hash", <span
								class="fstat-no" title="function not covered">function() {</span>
<span class="cstat-no" title="statement not covered">      handlebarsEnv.registerHelper('test_helper', <span
								class="fstat-no" title="function not covered">function() {</span> <span
								class="cstat-no" title="statement not covered">return 'found it!'; </span>});</span>
&nbsp;
<span class="cstat-no" title="statement not covered">      shouldCompileTo(</span>
        "{{test_helper}} {{#if cruel}}Goodbye {{cruel}} {{world}}!{{/if}}", [
          {cruel: "cruel"},
          {world: <span class="fstat-no" title="function not covered">function() {</span> <span
								class="cstat-no" title="statement not covered">return "world!"; </span>}}
        ],
        "found it! Goodbye cruel world!!");
    });
  });
&nbsp;
  it("Multiple global helper registration", <span class="fstat-no"
								title="function not covered">function() {</span>
...
<span class="cstat-no" title="statement not covered">    handlebarsEnv.registerHelper({</span>
      ...
      world: <span class="fstat-no" title="function not covered">function() {</span> <span
								class="cstat-no" title="statement not covered">return "world!"; </span>},
      test_helper: <span class="fstat-no" title="function not covered">function() {</span> <span
								class="cstat-no" title="statement not covered">return 'found it!'; </span>}
    });
&nbsp;
<span class="cstat-no" title="statement not covered">    shouldCompileTo(</span>
      "{{test_helper}} {{#if cruel}}Goodbye {{cruel}} {{world}}!{{/if}}",
...
&nbsp;
  it("decimal number literals work", <span class="fstat-no"
								title="function not covered">function() {</span>
<span class="cstat-no" title="statement not covered">    var string   = 'Message: {{hello -1.2 1.2}}';</span>
<span class="cstat-no" title="statement not covered">    var hash     = {};</span>
<span class="cstat-no" title="statement not covered">    var helpers  = {hello: <span
								class="fstat-no" title="function not covered">function(times, times2) {</span></span>
<span class="cstat-no" title="statement not covered">      if(typeof times !== 'number') { <span
								class="cstat-no" title="statement not covered">times = "NaN"; </span>}</span>
<span class="cstat-no" title="statement not covered">      if(typeof times2 !== 'number') { <span
								class="cstat-no" title="statement not covered">times2 = "NaN"; </span>}</span>
...
&nbsp;
  it("negative number literals work", <span class="fstat-no"
								title="function not covered">function() {</span>
<span class="cstat-no" title="statement not covered">    var string   = 'Message: {{hello -12}}';</span>
<span class="cstat-no" title="statement not covered">    var hash     = {};</span>
<span class="cstat-no" title="statement not covered">    var helpers  = {hello: <span
								class="fstat-no" title="function not covered">function(times) {</span></span>
<span class="cstat-no" title="statement not covered">      if(typeof times !== 'number') { <span
								class="cstat-no" title="statement not covered">times = "NaN"; </span>}</span>
...
&nbsp;
  describe("String literal parameters", function() {
    it("simple literals work", <span class="fstat-no"
								title="function not covered">function() {</span>
<span class="cstat-no" title="statement not covered">      var string   = 'Message: {{hello "world" 12 true false}}';</span>
<span class="cstat-no" title="statement not covered">      var hash     = {};</span>
<span class="cstat-no" title="statement not covered">      var helpers  = {hello: <span
								class="fstat-no" title="function not covered">function(param, times, bool1, bool2) {</span></span>
<span class="cstat-no" title="statement not covered">        if(typeof times !== 'number') { <span
								class="cstat-no" title="statement not covered">times = "NaN"; </span>}</span>
<span class="cstat-no" title="statement not covered">        if(typeof bool1 !== 'boolean') { <span
								class="cstat-no" title="statement not covered">bool1 = "NaB"; </span>}</span>
<span class="cstat-no" title="statement not covered">        if(typeof bool2 !== 'boolean') { <span
								class="cstat-no" title="statement not covered">bool2 = "NaB"; </span>}</span>
...
&nbsp;
    it("using a quote in the middle of a parameter raises an error", <span
								class="fstat-no" title="function not covered">function() {</span>
<span class="cstat-no" title="statement not covered">      var string   = 'Message: {{hello wo"rld"}}';</span>
<span class="cstat-no" title="statement not covered">      shouldThrow(<span
								class="fstat-no" title="function not covered">function() {</span></span>
<span class="cstat-no" title="statement not covered">        CompilerContext.compile(string);</span>
      }, Error);
    });
&nbsp;
    it("escaping a String is possible", <span class="fstat-no"
								title="function not covered">function(){</span>
<span class="cstat-no" title="statement not covered">      var string   = 'Message: {{{hello "\\"world\\""}}}';</span>
<span class="cstat-no" title="statement not covered">      var hash     = {};</span>
<span class="cstat-no" title="statement not covered">      var helpers = {hello: <span
								class="fstat-no" title="function not covered">function(param) {</span> <span
								class="cstat-no" title="statement not covered">return "Hello " + param; </span>}};</span>
...
&nbsp;
    it("it works with ' marks", <span class="fstat-no"
								title="function not covered">function() {</span>
...
&nbsp;
  describe("multiple parameters", function() {
    it("simple multi-params work", <span class="fstat-no"
								title="function not covered">function() {</span>
...
<span class="cstat-no" title="statement not covered">      var helpers = {goodbye: <span
								class="fstat-no" title="function not covered">function(cruel, world) {</span> <span
								class="cstat-no" title="statement not covered">return "Goodbye " + cruel + " " + world; </span>}};</span>
...
&nbsp;
    it("block multi-params work", <span class="fstat-no"
								title="function not covered">function() {</span>
<span class="cstat-no" title="statement not covered">      var string   = 'Message: {{#goodbye cruel world}}{{greeting}} {{adj}} {{noun}}{{/goodbye}}';</span>
<span class="cstat-no" title="statement not covered">      var hash     = {cruel: "cruel", world: "world"};</span>
<span class="cstat-no" title="statement not covered">      var helpers = {goodbye: <span
								class="fstat-no" title="function not covered">function(cruel, world, options) {</span></span>
...
&nbsp;
  describe('hash', function() {
    it("helpers can take an optional hash", <span class="fstat-no"
								title="function not covered">function() {</span>
...
&nbsp;
    it("helpers can take an optional hash with booleans", <span
								class="fstat-no" title="function not covered">function() {</span>
<span class="cstat-no" title="statement not covered">      var helpers = {</span>
        goodbye: <span class="fstat-no" title="function not covered">function(options) {</span>
...
&nbsp;
    it("block helpers can take an optional hash", <span class="fstat-no"
								title="function not covered">function() {</span>
...
&nbsp;
    it("block helpers can take an optional hash with single quoted stings", <span
								class="fstat-no" title="function not covered">function() {</span>
<span class="cstat-no" title="statement not covered">      var template = CompilerContext.compile("{{#goodbye cruel='CRUEL' times=12}}world{{/goodbye}}");</span>
&nbsp;
<span class="cstat-no" title="statement not covered">      var helpers = {</span>
...
&nbsp;
    it("block helpers can take an optional hash with booleans", <span
								class="fstat-no" title="function not covered">function() {</span>
<span class="cstat-no" title="statement not covered">      var helpers = {</span>
        goodbye: <span class="fstat-no" title="function not covered">function(options) {</span>
<span class="cstat-no" title="statement not covered">          if (options.hash.print === true) {</span>
...
&nbsp;
  describe("helperMissing", function() {
    it("if a context is not found, helperMissing is used", <span
								class="fstat-no" title="function not covered">function() {</span>
<span class="cstat-no" title="statement not covered">      shouldThrow(<span
								class="fstat-no" title="function not covered">function() {</span></span>
...
&nbsp;
    it("if a context is not found, custom helperMissing is used", <span
								class="fstat-no" title="function not covered">function() {</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered">      var helpers = {</span>
        helperMissing: <span class="fstat-no"
								title="function not covered">function(mesg, options) {</span>
...
&nbsp;
  describe("knownHelpers", function() {
    it("Known helper should render helper", <span class="fstat-no"
								title="function not covered">function() {</span>
<span class="cstat-no" title="statement not covered">      var template = CompilerContext.compile("{{hello}}", {knownHelpers: {"hello" : true}});</span>
&nbsp;
<span class="cstat-no" title="statement not covered">      var result = template({}, {helpers: {hello: <span
								class="fstat-no" title="function not covered">function() {</span> <span
								class="cstat-no" title="statement not covered">return "foo"; </span>}}});</span>
<span class="cstat-no" title="statement not covered">      equal(result, "foo", "'foo' should === '" + result);</span>
    });
&nbsp;
    it("Unknown helper in knownHelpers only mode should be passed as undefined", <span
								class="fstat-no" title="function not covered">function() {</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered">      var result = template({}, {helpers: {'typeof': <span
								class="fstat-no" title="function not covered">function(arg) {</span> <span
								class="cstat-no" title="statement not covered">return typeof arg; </span>}, hello: <span
								class="fstat-no" title="function not covered">function() {</span> <span
								class="cstat-no" title="statement not covered">return "foo"; </span>}}});</span>
<span class="cstat-no" title="statement not covered">      equal(result, "undefined", "'undefined' should === '" + result);</span>
    });
    it("Builtin helpers available in knownHelpers only mode", <span
								class="fstat-no" title="function not covered">function() {</span>
...
<span class="cstat-no" title="statement not covered">      equal(result, "bar", "'bar' should === '" + result);</span>
    ...
    it("Field lookup works in knownHelpers only mode", <span
								class="fstat-no" title="function not covered">function() {</span>
...
<span class="cstat-no" title="statement not covered">      equal(result, "bar", "'bar' should === '" + result);</span>
    ...
    it("Conditional blocks work in knownHelpers only mode", <span
								class="fstat-no" title="function not covered">function() {</span>
...
<span class="cstat-no" title="statement not covered">      equal(result, "bar", "'bar' should === '" + result);</span>
    ...
    it("Invert blocks work in knownHelpers only mode", <span
								class="fstat-no" title="function not covered">function() {</span>
<span class="cstat-no" title="statement not covered">      var template = CompilerContext.compile("{{^foo}}bar{{/foo}}", {knownHelpersOnly: true});</span>
&nbsp;
...
<span class="cstat-no" title="statement not covered">      equal(result, "bar", "'bar' should === '" + result);</span>
    ...
    it("Functions are bound to the context in knownHelpers only mode", <span
								class="fstat-no" title="function not covered">function() {</span>
<span class="cstat-no" title="statement not covered">      var template = CompilerContext.compile("{{foo}}", {knownHelpersOnly: true});</span>
<span class="cstat-no" title="statement not covered">      var result = template({foo: <span
								class="fstat-no" title="function not covered">function() {</span> <span
								class="cstat-no" title="statement not covered">return this.bar; </span>}, bar: 'bar'});</span>
<span class="cstat-no" title="statement not covered">      equal(result, "bar", "'bar' should === '" + result);</span>
    });
    it("Unknown helper call in knownHelpers only mode should throw", <span
								class="fstat-no" title="function not covered">function() {</span>
<span class="cstat-no" title="statement not covered">      shouldThrow(<span
								class="fstat-no" title="function not covered">function() {</span></span>
...
&nbsp;
  describe("blockHelperMissing", function() {
    it("lambdas are resolved by blockHelperMissing, not handlebars proper", <span
								class="fstat-no" title="function not covered">function() {</span>
<span class="cstat-no" title="statement not covered">      var string = "{{#truthy}}yep{{/truthy}}";</span>
<span class="cstat-no" title="statement not covered">      var data = { truthy: <span
								class="fstat-no" title="function not covered">function() {</span> <span
								class="cstat-no" title="statement not covered">return true; </span>} };</span>
<span class="cstat-no" title="statement not covered">      shouldCompileTo(string, data, "yep");</span>
    });
    it("lambdas resolved by blockHelperMissing are bound to the context", <span
								class="fstat-no" title="function not covered">function() {</span>
<span class="cstat-no" title="statement not covered">      var string = "{{#truthy}}yep{{/truthy}}";</span>
<span class="cstat-no" title="statement not covered">      var boundData = { truthy: <span
								class="fstat-no" title="function not covered">function() {</span> <span
								class="cstat-no" title="statement not covered">return this.truthiness(); </span>}, truthiness: <span
								class="fstat-no" title="function not covered">function() {</span> <span
								class="cstat-no" title="statement not covered">return false; </span>} };</span>
...
&nbsp;
  describe('name field', function() {
    var context = {};
    var helpers = {
      blockHelperMissing: <span class="fstat-no"
								title="function not covered">function() {</span>
...
&nbsp;
    it('should include full id', <span class="fstat-no"
								title="function not covered">function() {</span>
...
&nbsp;
    it('should include full id if a hash is passed', <span
								class="fstat-no" title="function not covered">function() {</span>
...
&nbsp;
  describe('name conflicts', function() {
    it("helpers take precedence over same-named context properties", <span
								class="fstat-no" title="function not covered">function() {</span>
...
&nbsp;
    it("Scoped names take precedence over helpers", <span
								class="fstat-no" title="function not covered">function() {</span>
...
&nbsp;
    it("Scoped names take precedence over block helpers", <span
								class="fstat-no" title="function not covered">function() {</span>
...
&nbsp;</pre></td>
	...
	<div class="footer">
		<div class="meta">
			...
			at Wed Aug 13 2014 23:50:21 GMT-0500 (CDT)
		</div>
	</div>
