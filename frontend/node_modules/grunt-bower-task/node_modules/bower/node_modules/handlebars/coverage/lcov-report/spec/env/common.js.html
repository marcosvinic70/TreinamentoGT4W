...
<body>
	<div class="header low">
		<h1>
			Code coverage report for <span class="entity">spec/env/common.js</span>
		</h1>
		<h2>

			Statements: <span class="metric">16.67% <small>(5 /
					30)</small></span> &nbsp;&nbsp;&nbsp;&nbsp; Branches: <span class="metric">0%
				<small>(0 / 22)</small>
			</span> &nbsp;&nbsp;&nbsp;&nbsp; Functions: <span class="metric">0% <small>(0
					/ 5)</small></span> &nbsp;&nbsp;&nbsp;&nbsp; Lines: <span class="metric">16.67%
				<small>(5 / 30)</small>
			</span> &nbsp;&nbsp;&nbsp;&nbsp; Ignored: <span class="metric"><span
				class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
		</h2>
		<div class="path">
			<a href="../../index.html">All files</a> &#187; <a href="index.html">spec/env/</a>
			&#187; common.js
		</div>
	</div>
	<div class="body">
...
<span class="cline-any cline-neutral">&nbsp;</span></td>
					<td class="text"><pre class="prettyprint lang-js">/*global CompilerContext, compileWithPartials, shouldCompileToWithPartials */
global.shouldCompileTo = <span class="fstat-no"
								title="function not covered">function(string, hashOrArray, expected, message) {</span>
...
&nbsp;
global.shouldCompileToWithPartials = <span class="fstat-no"
								title="function not covered">function(string, hashOrArray, partials, expected, message) {</span>
...
&nbsp;
global.compileWithPartials = <span class="fstat-no"
								title="function not covered">function(string, hashOrArray, partials) {</span>
...
&nbsp;
&nbsp;
global.equals = global.equal = <span class="fstat-no"
								title="function not covered">function(a, b, msg) {</span>
