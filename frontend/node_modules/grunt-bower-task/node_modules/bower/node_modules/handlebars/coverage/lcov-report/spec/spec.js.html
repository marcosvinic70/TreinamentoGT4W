...
<body>
	<div class="header medium">
		<h1>
			Code coverage report for <span class="entity">spec/spec.js</span>
		</h1>
		<h2>

			Statements: <span class="metric">76.19% <small>(16 /
					21)</small></span> &nbsp;&nbsp;&nbsp;&nbsp; Branches: <span class="metric">73.33%
				<small>(11 / 15)</small>
			</span> &nbsp;&nbsp;&nbsp;&nbsp; Functions: <span class="metric">83.33%
				<small>(5 / 6)</small>
			</span> &nbsp;&nbsp;&nbsp;&nbsp; Lines: <span class="metric">76.19% <small>(16
...
<span class="cline-any cline-neutral">&nbsp;</span></td>
					<td class="text"><pre class="prettyprint lang-js">describe('spec', function() {
...
<span class="cstat-no" title="statement not covered">        data.lambda = eval('(' + data.lambda.js + ')');</span>
      ...
      it(name + ' - ' + test.name, <span class="fstat-no"
