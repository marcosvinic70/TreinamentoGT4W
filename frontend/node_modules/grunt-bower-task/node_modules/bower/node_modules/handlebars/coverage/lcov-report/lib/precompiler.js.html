...
<body>
	<div class="header high">
		<h1>
			Code coverage report for <span class="entity">lib/precompiler.js</span>
		</h1>
		<h2>

			Statements: <span class="metric">97.53% <small>(79 /
					81)</small></span> &nbsp;&nbsp;&nbsp;&nbsp; Branches: <span class="metric">94.59%
				<small>(70 / 74)</small>
			</span> &nbsp;&nbsp;&nbsp;&nbsp; Functions: <span class="metric">100%
				<small>(6 / 6)</small>
			</span> &nbsp;&nbsp;&nbsp;&nbsp; Lines: <span class="metric">97.5% <small>(78
					/ 80)</small></span> &nbsp;&nbsp;&nbsp;&nbsp; Ignored: <span class="metric"><span
...
&nbsp;
      <span class="missing-if-branch" title="if path not taken">I</span>if (opts.bom &amp;&amp; <span
								class="branch-1 cbranch-no" title="branch not covered">data.indexOf('\uFEFF') === 0)</span> {
