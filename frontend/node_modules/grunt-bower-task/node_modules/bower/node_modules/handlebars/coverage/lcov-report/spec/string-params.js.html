...
<body>
	<div class="header low">
		<h1>
			Code coverage report for <span class="entity">spec/string-params.js</span>
		</h1>
		<h2>

			Statements: <span class="metric">11.9% <small>(10 /
					84)</small></span> &nbsp;&nbsp;&nbsp;&nbsp; Branches: <span class="metric">100%
				<small>(0 / 0)</small>
			</span> &nbsp;&nbsp;&nbsp;&nbsp; Functions: <span class="metric">4.35%
				<small>(1 / 23)</small>
			</span> &nbsp;&nbsp;&nbsp;&nbsp; Lines: <span class="metric">11.9% <small>(10
					/ 84)</small></span> &nbsp;&nbsp;&nbsp;&nbsp; Ignored: <span class="metric"><span
...
176
177</td>
					<td class="line-coverage"><span class="cline-any cline-yes">3</span>
...
<span class="cline-any cline-neutral">&nbsp;</span></td>
					<td class="text"><pre class="prettyprint lang-js">describe('string params mode', function() {
  it("arguments to helpers can be retrieved from options hash in string form", <span
...
&nbsp;
  it("when using block form, arguments to helpers can be retrieved from options hash in string form", <span
								class="fstat-no" title="function not covered">function() {</span>
...
&nbsp;
  it("when inside a block in String mode, .. passes the appropriate context in the options hash", <span
								class="fstat-no" title="function not covered">function() {</span>
...
&nbsp;
  it("information about the types is passed along", <span
								class="fstat-no" title="function not covered">function() {</span>
...
&nbsp;
  it("hash parameters get type information", <span class="fstat-no"
...
&nbsp;
  it("hash parameters get context information", <span class="fstat-no"
								title="function not covered">function() {</span>
...
&nbsp;
  it("when inside a block in String mode, .. passes the appropriate context in the options hash to a block helper", <span
								class="fstat-no" title="function not covered">function() {</span>
...
&nbsp;
  it("with nested block ambiguous", <span class="fstat-no"
								title="function not covered">function() {</span>
...
&nbsp;
  it('should handle DATA', <span class="fstat-no"
								title="function not covered">function() {</span>
