...
<title>Code coverage report for
	dist/cjs/handlebars/compiler/parser.js</title>
<meta charset="utf-8">
...
<body>
	<div class="header high">
		<h1>
			Code coverage report for <span class="entity">dist/cjs/handlebars/compiler/parser.js</span>
		</h1>
		<h2>

			Statements: <span class="metric">100% <small>(396 /
					396)</small></span> &nbsp;&nbsp;&nbsp;&nbsp; Branches: <span class="metric">100%
				<small>(205 / 205)</small>
			</span> &nbsp;&nbsp;&nbsp;&nbsp; Functions: <span class="metric">100%
				<small>(27 / 27)</small>
			</span> &nbsp;&nbsp;&nbsp;&nbsp; Lines: <span class="metric">100% <small>(369
					/ 369)</small></span> &nbsp;&nbsp;&nbsp;&nbsp; Ignored: <span class="metric">95
				statements, 9 functions, 45 branches</span> &nbsp;&nbsp;&nbsp;&nbsp;
		</h2>
		<div class="path">
			<a href="../../../../index.html">All files</a> &#187; <a
				href="index.html">dist/cjs/handlebars/compiler/</a> &#187; parser.js
		</div>
	</div>
	<div class="body">
		<pre>
...
var parser = {trace: <span class="fstat-skip"
								title="function not covered">function trace() {</span> },
yy: {},
...
<span class="cstat-skip" title="statement not covered">        lstack.length = lstack.length - n;</span>
    ...
    function lex() {
        var token;
        token = self.lexer.lex() || <span class="branch-1 cbranch-skip"
        ...
        if (typeof action === "undefined" || !action.length || !action[0]) {
            ...
            <span class="skip-if-branch" title="else path not taken">E</span>if (!recovering) {
                ...
                for (p in table[state])
                    <span class="skip-if-branch"
								title="else path not taken">E</span>if (this.terminals_[p] &amp;&amp; p &gt; 2) {
...
<span class="cstat-skip" title="statement not covered">                    errStr = "Parse error on line " + (yylineno + 1) + ": Unexpected " + (symbol == 1?"end of input":"'" + (this.terminals_[symbol] || symbol) + "'");</span>
        ...
        <span class="skip-if-branch" title="if path not taken">I</span>if (action[0] instanceof Array &amp;&amp; <span
								class="branch-1 cbranch-skip" title="branch not covered">action.length &gt; 1)</span> {
...
setInput:function (input) {
        ...
        <span class="skip-if-branch" title="if path not taken">I</span>if (this.options.ranges) <span
								class="cstat-skip" title="statement not covered">this.yylloc.range = [0,0];</span>
        this.offset = 0;
        return this;
    },
...
<span class="cstat-skip" title="statement not covered">        if (this.options.ranges) <span
								class="cstat-skip" title="statement not covered">this.yylloc.range[1]++;</span></span>
&nbsp;
...
&nbsp;
<span class="cstat-skip" title="statement not covered">        if (lines.length-1) <span
								class="cstat-skip" title="statement not covered">this.yylineno -= lines.length-1;</span></span>
...
pastInput:function () {
        ...
        return (past.length &gt; 20 ? <span
								class="branch-0 cbranch-skip" title="branch not covered">'...':</span>'') + past.substr(-20).replace(/\n/g, "");
    },
upcomingInput:function () {
        ...
        return (next.substr(0,20)+(next.length &gt; 20 ? <span
								class="branch-0 cbranch-skip" title="branch not covered">'...':</span>'')).replace(/\n/g, "");
    },
...
&nbsp;
        ...
        for (var i=0;i &lt; rules.length; i++) {
            ...
            if (tempMatch &amp;&amp; (!match || <span
								class="branch-2 cbranch-skip" title="branch not covered">tempMatch[0].length &gt; match[0].length)</span>) {
                match = tempMatch;
                index = i;
...
<span class="cstat-skip" title="statement not covered">                this.yylloc.range = [this.offset, this.offset += this.yyleng];</span>
            ...
            <span class="skip-if-branch" title="if path not taken">I</span>if (this.done &amp;&amp; this._input) <span
								class="cstat-skip" title="statement not covered">this.done = false;</span>
...
/* jshint ignore:end */</pre></td>
	...
	<div class="footer">
		<div class="meta">
			...
			at Mon Sep 01 2014 21:28:55 GMT-0500 (CDT)
		</div>
	</div>
