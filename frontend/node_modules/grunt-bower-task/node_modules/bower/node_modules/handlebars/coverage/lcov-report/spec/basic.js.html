...
<body>
	<div class="header low">
		<h1>
			Code coverage report for <span class="entity">spec/basic.js</span>
		</h1>
		<h2>

			Statements: <span class="metric">29.31% <small>(34 /
					116)</small></span> &nbsp;&nbsp;&nbsp;&nbsp; Branches: <span class="metric">100%
				<small>(0 / 0)</small>
			</span> &nbsp;&nbsp;&nbsp;&nbsp; Functions: <span class="metric">2.13%
				<small>(1 / 47)</small>
			</span> &nbsp;&nbsp;&nbsp;&nbsp; Lines: <span class="metric">30.09% <small>(34
					/ 113)</small></span> &nbsp;&nbsp;&nbsp;&nbsp; Ignored: <span class="metric"><span
...
<span class="cline-any cline-neutral">&nbsp;</span></td>
					<td class="text"><pre class="prettyprint lang-js">/*global CompilerContext, Handlebars, beforeEach, shouldCompileTo */
...
&nbsp;
  it("compiling with a basic context", <span class="fstat-no"
...
&nbsp;
  it("compiling with an undefined context", <span class="fstat-no"
								title="function not covered">function() {</span>
...
&nbsp;
  it("escaping text", <span class="fstat-no"
								title="function not covered">function() {</span>
...
&nbsp;
  it("escaping expressions", <span class="fstat-no"
								title="function not covered">function() {</span>
...
&nbsp;
  it("functions returning safestrings shouldn't be escaped", <span
								class="fstat-no" title="function not covered">function() {</span>
<span class="cstat-no" title="statement not covered">    var hash = {awesome: <span
								class="fstat-no" title="function not covered">function() {</span> <span
								class="cstat-no" title="statement not covered">return new Handlebars.SafeString("&amp;\"\\&lt;&gt;"); </span>}};</span>
...
<span class="cstat-no" title="statement not covered">    shouldCompileTo("{{awesome}}", {awesome: <span
								class="fstat-no" title="function not covered">function() {</span> <span
								class="cstat-no" title="statement not covered">return "Awesome"; </span>}}, "Awesome",</span>
                    "functions are called and render their output");
<span class="cstat-no" title="statement not covered">    shouldCompileTo("{{awesome}}", {awesome: <span
								class="fstat-no" title="function not covered">function() {</span> <span
								class="cstat-no" title="statement not covered">return this.more; </span>}, more:  "More awesome"}, "More awesome",</span>
                    "functions are bound to the context");
  });
&nbsp;
  it("functions with context argument", <span class="fstat-no"
								title="function not covered">function() {</span>
<span class="cstat-no" title="statement not covered">    shouldCompileTo("{{awesome frank}}",</span>
        {awesome: <span class="fstat-no" title="function not covered">function(context) {</span> <span
								class="cstat-no" title="statement not covered">return context; </span>},
          frank: "Frank"},
        "Frank", "functions are called with context arguments");
  });
  it("pathed functions with context argument", <span class="fstat-no"
								title="function not covered">function() {</span>
<span class="cstat-no" title="statement not covered">    shouldCompileTo("{{bar.awesome frank}}",</span>
        {bar: {awesome: <span class="fstat-no"
								title="function not covered">function(context) {</span> <span
								class="cstat-no" title="statement not covered">return context; </span>}},
          frank: "Frank"},
        "Frank", "functions are called with context arguments");
  });
  it("depthed functions with context argument", <span class="fstat-no"
								title="function not covered">function() {</span>
...
&nbsp;
  it("block functions with context argument", <span class="fstat-no"
								title="function not covered">function() {</span>
<span class="cstat-no" title="statement not covered">    shouldCompileTo("{{#awesome 1}}inner {{.}}{{/awesome}}",</span>
        {awesome: <span class="fstat-no" title="function not covered">function(context, options) {</span> <span
								class="cstat-no" title="statement not covered">return options.fn(context); </span>}},
        "inner 1", "block functions are called with context and options");
  });
&nbsp;
  it("depthed block functions with context argument", <span
								class="fstat-no" title="function not covered">function() {</span>
<span class="cstat-no" title="statement not covered">    shouldCompileTo("{{#with value}}{{#../awesome 1}}inner {{.}}{{/../awesome}}{{/with}}",</span>
        {value: true, awesome: <span class="fstat-no"
								title="function not covered">function(context, options) {</span> <span
								class="cstat-no" title="statement not covered">return options.fn(context); </span>}},
        "inner 1", "block functions are called with context and options");
  });
&nbsp;
  it("block functions without context argument", <span class="fstat-no"
								title="function not covered">function() {</span>
<span class="cstat-no" title="statement not covered">    shouldCompileTo("{{#awesome}}inner{{/awesome}}",</span>
        {awesome: <span class="fstat-no" title="function not covered">function(options) {</span> <span
								class="cstat-no" title="statement not covered">return options.fn(this); </span>}},
        "inner", "block functions are called with options");
  });
  it("pathed block functions without context argument", <span
								class="fstat-no" title="function not covered">function() {</span>
<span class="cstat-no" title="statement not covered">    shouldCompileTo("{{#foo.awesome}}inner{{/foo.awesome}}",</span>
        {foo: {awesome: <span class="fstat-no"
								title="function not covered">function(options) {</span> <span
								class="cstat-no" title="statement not covered">return this; </span>}}},
        "inner", "block functions are called with options");
  });
  it("depthed block functions without context argument", <span
								class="fstat-no" title="function not covered">function() {</span>
...
&nbsp;
&nbsp;
  it("paths with hyphens", <span class="fstat-no"
								title="function not covered">function() {</span>
...
&nbsp;
  it("nested paths with empty string value", <span class="fstat-no"
								title="function not covered">function() {</span>
...
&nbsp;
  it("literal paths", <span class="fstat-no"
								title="function not covered">function() {</span>
<span class="cstat-no" title="statement not covered">    shouldCompileTo("Goodbye {{[@alan]/expression}} world!", {"@alan": {expression: "beautiful"}},</span>
...
&nbsp;
  it("this keyword in paths", <span class="fstat-no"
								title="function not covered">function() {</span>
...
&nbsp;
  it("this keyword nested inside path", <span class="fstat-no"
								title="function not covered">function() {</span>
...
&nbsp;
  it("this keyword in helpers", <span class="fstat-no"
								title="function not covered">function() {</span>
<span class="cstat-no" title="statement not covered">    var helpers = {foo: <span
								class="fstat-no" title="function not covered">function(value) {</span></span>
...
&nbsp;
  it("this keyword nested inside helpers param", <span class="fstat-no"
								title="function not covered">function() {</span>
