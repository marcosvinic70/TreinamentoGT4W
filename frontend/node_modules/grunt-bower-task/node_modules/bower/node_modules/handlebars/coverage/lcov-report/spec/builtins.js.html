...
<body>
	<div class="header low">
		<h1>
			Code coverage report for <span class="entity">spec/builtins.js</span>
		</h1>
		<h2>

			Statements: <span class="metric">20% <small>(27 / 135)</small></span>
			&nbsp;&nbsp;&nbsp;&nbsp; Branches: <span class="metric">0% <small>(0
					/ 4)</small></span> &nbsp;&nbsp;&nbsp;&nbsp; Functions: <span class="metric">13.89%
				<small>(5 / 36)</small>
			</span> &nbsp;&nbsp;&nbsp;&nbsp; Lines: <span class="metric">20.93% <small>(27
					/ 129)</small></span> &nbsp;&nbsp;&nbsp;&nbsp; Ignored: <span class="metric"><span
...
<span class="cline-any cline-neutral">&nbsp;</span></td>
					<td class="text"><pre class="prettyprint lang-js">/*global CompilerContext, shouldCompileTo, shouldThrow, compileWithPartials, handlebarsEnv */
...
&nbsp;
    it("if with function argument", <span class="fstat-no"
								title="function not covered">function() {</span>
<span class="cstat-no" title="statement not covered">      var string   = "{{#if goodbye}}GOODBYE {{/if}}cruel {{world}}!";</span>
<span class="cstat-no" title="statement not covered">      shouldCompileTo(string, {goodbye: <span
								class="fstat-no" title="function not covered">function() {<span
									class="cstat-no" title="statement not covered"></span>return true;}</span>, world: "world"}, "GOODBYE cruel world!",</span>
                      "if with function shows the contents when function returns true");
<span class="cstat-no" title="statement not covered">      shouldCompileTo(string, {goodbye: <span
								class="fstat-no" title="function not covered">function() {<span
									class="cstat-no" title="statement not covered"></span>return this.world;}</span>, world: "world"}, "GOODBYE cruel world!",</span>
                      "if with function shows the contents when function returns string");
<span class="cstat-no" title="statement not covered">      shouldCompileTo(string, {goodbye: <span
								class="fstat-no" title="function not covered">function() {<span
									class="cstat-no" title="statement not covered"></span>return false;}</span>, world: "world"}, "cruel world!",</span>
                      "if with function does not show the contents when returns false");
<span class="cstat-no" title="statement not covered">      shouldCompileTo(string, {goodbye: <span
								class="fstat-no" title="function not covered">function() {<span
									class="cstat-no" title="statement not covered"></span>return this.foo;}</span>, world: "world"}, "cruel world!",</span>
...
<span class="cstat-no" title="statement not covered">      shouldCompileTo(string, {person: {first: "Alan", last: "Johnson"}}, "Alan Johnson");</span>
    ...
    it("with with function argument", <span class="fstat-no"
								title="function not covered">function() {</span>
<span class="cstat-no" title="statement not covered">      var string = "{{#with person}}{{first}} {{last}}{{/with}}";</span>
<span class="cstat-no" title="statement not covered">      shouldCompileTo(string, {person: <span
								class="fstat-no" title="function not covered">function() {</span> <span
								class="cstat-no" title="statement not covered">return {first: "Alan", last: "Johnson"};}</span>}, "Alan Johnson");</span>
    });
    it("with with else", <span class="fstat-no"
								title="function not covered">function() {</span>
...
<span class="cstat-no" title="statement not covered">      handlebarsEnv.registerHelper('detectDataInsideEach', <span
...
&nbsp;
    it("each with an object and @key", <span class="fstat-no"
								title="function not covered">function() {</span>
...
&nbsp;
    it("each with @index", <span class="fstat-no"
								title="function not covered">function() {</span>
...
&nbsp;
    it("each with nested @index", <span class="fstat-no"
								title="function not covered">function() {</span>
...
&nbsp;
    it("each object with @index", <span class="fstat-no"
								title="function not covered">function() {</span>
<span class="cstat-no" title="statement not covered">      var string = "{{#each goodbyes}}{{@index}}. {{text}}! {{/each}}cruel {{world}}!";</span>
...
&nbsp;
&nbsp;
    it("each with @first", <span class="fstat-no"
								title="function not covered">function() {</span>
...
&nbsp;
    it("each with nested @first", <span class="fstat-no"
								title="function not covered">function() {</span>
...
&nbsp;
    it("each object with @first", <span class="fstat-no"
								title="function not covered">function() {</span>
<span class="cstat-no" title="statement not covered">      var string = "{{#each goodbyes}}{{#if @first}}{{text}}! {{/if}}{{/each}}cruel {{world}}!";</span>
...
&nbsp;
    it("each with @last", <span class="fstat-no"
								title="function not covered">function() {</span>
...
&nbsp;
    it("each with nested @last", <span class="fstat-no"
								title="function not covered">function() {</span>
...
&nbsp;
    it("each with function argument", <span class="fstat-no"
								title="function not covered">function() {</span>
<span class="cstat-no" title="statement not covered">      var string = "{{#each goodbyes}}{{text}}! {{/each}}cruel {{world}}!";</span>
<span class="cstat-no" title="statement not covered">      var hash   = {goodbyes: <span
								class="fstat-no" title="function not covered">function () {</span> <span
								class="cstat-no" title="statement not covered">return [{text: "goodbye"}, {text: "Goodbye"}, {text: "GOODBYE"}];}</span>, world: "world"};</span>
<span class="cstat-no" title="statement not covered">      shouldCompileTo(string, hash, "goodbye! Goodbye! GOODBYE! cruel world!",</span>
...
&nbsp;
    it("data passed to helpers", <span class="fstat-no"
								title="function not covered">function() {</span>
...
&nbsp;
    it("each on implicit context", <span class="fstat-no"
								title="function not covered">function() {</span>
...
<span class="cstat-no" title="statement not covered">    handlebarsEnv.log = <span
								class="fstat-no" title="function not covered">function(level, arg){</span></span>
...
&nbsp;
  describe('#lookup', function() {
    it('should lookup arbitrary content', <span class="fstat-no"
								title="function not covered">function() {</span>
...
<span class="cstat-no" title="statement not covered">      equal(result, 'foobar');</span>
    ...
    it('should not fail on undefined value', <span class="fstat-no"
								title="function not covered">function() {</span>
