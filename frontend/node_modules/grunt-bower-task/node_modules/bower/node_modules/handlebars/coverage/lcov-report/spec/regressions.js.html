...
<body>
	<div class="header low">
		<h1>
			Code coverage report for <span class="entity">spec/regressions.js</span>
		</h1>
		<h2>

			Statements: <span class="metric">27.94% <small>(19 /
					68)</small></span> &nbsp;&nbsp;&nbsp;&nbsp; Branches: <span class="metric">100%
				<small>(2 / 2)</small>
			</span> &nbsp;&nbsp;&nbsp;&nbsp; Functions: <span class="metric">4% <small>(1
					/ 25)</small></span> &nbsp;&nbsp;&nbsp;&nbsp; Lines: <span class="metric">27.94%
				<small>(19 / 68)</small>
			</span> &nbsp;&nbsp;&nbsp;&nbsp; Ignored: <span class="metric"><span
...
<span class="cline-any cline-neutral">&nbsp;</span></td>
					<td class="text"><pre class="prettyprint lang-js">/*global CompilerContext, Handlebars, shouldCompileTo, shouldThrow */
describe('Regressions', function() {
  it("GH-94: Cannot read property of undefined", <span class="fstat-no"
...
&nbsp;
  it("GH-150: Inverted sections print when they shouldn't", <span
...
&nbsp;
  it("GH-158: Using array index twice, breaks the template", <span
								class="fstat-no" title="function not covered">function() {</span>
...
&nbsp;
  it("bug reported by @fat where lambdas weren't being properly resolved", <span
								class="fstat-no" title="function not covered">function() {</span>
...
&nbsp;
  it('GH-408: Multiple loops fail', <span class="fstat-no"
								title="function not covered">function() {</span>
...
&nbsp;
  it('GS-428: Nested if else rendering', <span class="fstat-no"
								title="function not covered">function() {</span>
...
<span class="cstat-no" title="statement not covered">    var helpers = {</span>
      blk: <span class="fstat-no" title="function not covered">function(block) {</span> <span
								class="cstat-no" title="statement not covered">return block.fn(''); </span>},
      inverse: <span class="fstat-no" title="function not covered">function(block) {</span> <span
								class="cstat-no" title="statement not covered">return block.inverse(''); </span>}
    };
&nbsp;
...
&nbsp;
  it('GH-458: Scoped this identifier', <span class="fstat-no"
								title="function not covered">function() {</span>
<span class="cstat-no" title="statement not covered">    shouldCompileTo('{{./foo}}', {foo: 'bar'}, 'bar');</span>
  });
&nbsp;
  it('GH-375: Unicode line terminators', <span class="fstat-no"
								title="function not covered">function() {</span>
<span class="cstat-no" title="statement not covered">    shouldCompileTo('\u2028', {}, '\u2028');</span>
  });
&nbsp;
  it('GH-534: Object prototype aliases', <span class="fstat-no"
								title="function not covered">function() {</span>
...
&nbsp;
  it('GH-437: Matching escaping', <span class="fstat-no"
								title="function not covered">function() {</span>
...
&nbsp;
  it("GH-676: Using array in escaping mustache fails", <span
								class="fstat-no" title="function not covered">function() {</span>
...
&nbsp;
  it("Mustache man page", <span class="fstat-no"
								title="function not covered">function() {</span>
...
&nbsp;
  it("Passing falsy values to Handlebars.compile throws an error", <span
								class="fstat-no" title="function not covered">function() {</span>
<span class="cstat-no" title="statement not covered">    shouldThrow(<span
								class="fstat-no" title="function not covered">function() {</span></span>
...
&nbsp;
    it("can pass through an empty string", <span class="fstat-no"
								title="function not covered">function() {</span>
