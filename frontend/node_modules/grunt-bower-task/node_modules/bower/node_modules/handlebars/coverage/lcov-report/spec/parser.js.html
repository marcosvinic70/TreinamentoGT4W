...
<body>
	<div class="header low">
		<h1>
			Code coverage report for <span class="entity">spec/parser.js</span>
		</h1>
		<h2>

			Statements: <span class="metric">37.5% <small>(39 /
					104)</small></span> &nbsp;&nbsp;&nbsp;&nbsp; Branches: <span class="metric">100%
				<small>(2 / 2)</small>
			</span> &nbsp;&nbsp;&nbsp;&nbsp; Functions: <span class="metric">4.44%
				<small>(2 / 45)</small>
			</span> &nbsp;&nbsp;&nbsp;&nbsp; Lines: <span class="metric">37.5% <small>(39
					/ 104)</small></span> &nbsp;&nbsp;&nbsp;&nbsp; Ignored: <span class="metric"><span
...
&nbsp;
  it('parses simple mustaches', <span class="fstat-no"
...
&nbsp;
  it('parses simple mustaches with data', <span class="fstat-no"
								title="function not covered">function() {</span>
<span class="cstat-no" title="statement not covered">    equals(ast_for("{{@foo}}"), "{{ @ID:foo [] }}\n");</span>
  });
&nbsp;
  it('parses simple mustaches with data paths', <span class="fstat-no"
								title="function not covered">function() {</span>
<span class="cstat-no" title="statement not covered">    equals(ast_for("{{@../foo}}"), "{{ @ID:foo [] }}\n");</span>
  });
&nbsp;
  it('parses mustaches with paths', <span class="fstat-no"
								title="function not covered">function() {</span>
<span class="cstat-no" title="statement not covered">    equals(ast_for("{{foo/bar}}"), "{{ PATH:foo/bar [] }}\n");</span>
  });
&nbsp;
  it('parses mustaches with this/foo', <span class="fstat-no"
								title="function not covered">function() {</span>
<span class="cstat-no" title="statement not covered">    equals(ast_for("{{this/foo}}"), "{{ ID:foo [] }}\n");</span>
  });
&nbsp;
  it('parses mustaches with - in a path', <span class="fstat-no"
								title="function not covered">function() {</span>
<span class="cstat-no" title="statement not covered">    equals(ast_for("{{foo-bar}}"), "{{ ID:foo-bar [] }}\n");</span>
  });
&nbsp;
  it('parses mustaches with parameters', <span class="fstat-no"
								title="function not covered">function() {</span>
<span class="cstat-no" title="statement not covered">    equals(ast_for("{{foo bar}}"), "{{ ID:foo [ID:bar] }}\n");</span>
  });
&nbsp;
  it('parses mustaches with string parameters', <span class="fstat-no"
								title="function not covered">function() {</span>
<span class="cstat-no" title="statement not covered">    equals(ast_for("{{foo bar \"baz\" }}"), '{{ ID:foo [ID:bar, "baz"] }}\n');</span>
  });
&nbsp;
  it('parses mustaches with NUMBER parameters', <span class="fstat-no"
								title="function not covered">function() {</span>
<span class="cstat-no" title="statement not covered">    equals(ast_for("{{foo 1}}"), "{{ ID:foo [NUMBER{1}] }}\n");</span>
  });
&nbsp;
  it('parses mustaches with BOOLEAN parameters', <span class="fstat-no"
								title="function not covered">function() {</span>
...
&nbsp;
  it('parses mutaches with DATA parameters', <span class="fstat-no"
								title="function not covered">function() {</span>
<span class="cstat-no" title="statement not covered">    equals(ast_for("{{foo @bar}}"), "{{ ID:foo [@ID:bar] }}\n");</span>
  });
&nbsp;
  it('parses mustaches with hash arguments', <span class="fstat-no"
								title="function not covered">function() {</span>
...
&nbsp;
  it('knows how to report the correct line number in errors', <span
								class="fstat-no" title="function not covered">function() {</span>
<span class="cstat-no" title="statement not covered">    shouldThrow(<span
								class="fstat-no" title="function not covered">function() {</span></span>
...
&nbsp;
  describe('externally compiled AST', function() {
    it('can pass through an already-compiled AST', <span
								class="fstat-no" title="function not covered">function() {</span>
