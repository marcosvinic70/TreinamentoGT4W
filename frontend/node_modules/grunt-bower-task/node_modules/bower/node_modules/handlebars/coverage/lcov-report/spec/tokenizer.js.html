...
<body>
	<div class="header low">
		<h1>
			Code coverage report for <span class="entity">spec/tokenizer.js</span>
		</h1>
		<h2>

			Statements: <span class="metric">20.91% <small>(55 /
					263)</small></span> &nbsp;&nbsp;&nbsp;&nbsp; Branches: <span class="metric">22.22%
				<small>(2 / 9)</small>
			</span> &nbsp;&nbsp;&nbsp;&nbsp; Functions: <span class="metric">1.89%
				<small>(1 / 53)</small>
			</span> &nbsp;&nbsp;&nbsp;&nbsp; Lines: <span class="metric">20.91% <small>(55
					/ 263)</small></span> &nbsp;&nbsp;&nbsp;&nbsp; Ignored: <span class="metric"><span
...
<span class="cline-any cline-neutral">&nbsp;</span></td>
					<td class="text"><pre class="prettyprint lang-js">
							<span class="fstat-no" title="function not covered">function shouldMatchTokens(result, tokens) {</span>
...
&nbsp;
  it('tokenizes a simple mustache as "OPEN ID CLOSE"', <span
...
&nbsp;
  it('supports unescaping with &amp;', <span class="fstat-no"
...
&nbsp;
  it('supports escaping delimiters', <span class="fstat-no"
								title="function not covered">function() {</span>
...
&nbsp;
  it('supports escaping multiple delimiters', <span class="fstat-no"
								title="function not covered">function() {</span>
<span class="cstat-no" title="statement not covered">    var result = tokenize("{{foo}} \\{{bar}} \\{{baz}}");</span>
...
&nbsp;
  it('supports escaping a triple stash', <span class="fstat-no"
								title="function not covered">function() {</span>
<span class="cstat-no" title="statement not covered">    var result = tokenize("{{foo}} \\{{{bar}}} {{baz}}");</span>
<span class="cstat-no" title="statement not covered">    shouldMatchTokens(result, ['OPEN', 'ID', 'CLOSE', 'CONTENT', 'CONTENT', 'OPEN', 'ID', 'CLOSE']);</span>
&nbsp;
...
&nbsp;
  it('supports escaping escape character', <span class="fstat-no"
								title="function not covered">function() {</span>
<span class="cstat-no" title="statement not covered">    var result = tokenize("{{foo}} \\\\{{bar}} {{baz}}");</span>
...
&nbsp;
  it('supports escaping multiple escape characters', <span
								class="fstat-no" title="function not covered">function() {</span>
<span class="cstat-no" title="statement not covered">    var result = tokenize("{{foo}} \\\\{{bar}} \\\\{{baz}}");</span>
<span class="cstat-no" title="statement not covered">    shouldMatchTokens(result, ['OPEN', 'ID', 'CLOSE', 'CONTENT', 'OPEN', 'ID', 'CLOSE', 'CONTENT', 'OPEN', 'ID', 'CLOSE']);</span>
&nbsp;
...
&nbsp;
  it('supports escaped mustaches after escaped escape characters', <span
								class="fstat-no" title="function not covered">function() {</span>
<span class="cstat-no" title="statement not covered">    var result = tokenize("{{foo}} \\\\{{bar}} \\{{baz}}");</span>
...
&nbsp;
  it('supports escaped escape characters after escaped mustaches', <span
								class="fstat-no" title="function not covered">function() {</span>
<span class="cstat-no" title="statement not covered">    var result = tokenize("{{foo}} \\{{bar}} \\\\{{baz}}");</span>
...
&nbsp;
  it('supports escaped escape character on a triple stash', <span
								class="fstat-no" title="function not covered">function() {</span>
<span class="cstat-no" title="statement not covered">    var result = tokenize("{{foo}} \\\\{{{bar}}} {{baz}}");</span>
...
&nbsp;
  it('tokenizes a simple path', <span class="fstat-no"
								title="function not covered">function() {</span>
...
&nbsp;
  it('allows dot notation', <span class="fstat-no"
								title="function not covered">function() {</span>
<span class="cstat-no" title="statement not covered">    var result = tokenize("{{foo.bar}}");</span>
<span class="cstat-no" title="statement not covered">    shouldMatchTokens(result, ['OPEN', 'ID', 'SEP', 'ID', 'CLOSE']);</span>
&nbsp;
...
&nbsp;
  it('allows path literals with []', <span class="fstat-no"
								title="function not covered">function() {</span>
<span class="cstat-no" title="statement not covered">    var result = tokenize("{{foo.[bar]}}");</span>
<span class="cstat-no" title="statement not covered">    shouldMatchTokens(result, ['OPEN', 'ID', 'SEP', 'ID', 'CLOSE']);</span>
  });
&nbsp;
  it('allows multiple path literals on a line with []', <span
								class="fstat-no" title="function not covered">function() {</span>
...
&nbsp;
  it('tokenizes {{.}} as OPEN ID CLOSE', <span class="fstat-no"
								title="function not covered">function() {</span>
<span class="cstat-no" title="statement not covered">    var result = tokenize("{{.}}");</span>
<span class="cstat-no" title="statement not covered">    shouldMatchTokens(result, ['OPEN', 'ID', 'CLOSE']);</span>
  });
&nbsp;
  it('tokenizes a path as "OPEN (ID SEP)* ID CLOSE"', <span
								class="fstat-no" title="function not covered">function() {</span>
<span class="cstat-no" title="statement not covered">    var result = tokenize("{{../foo/bar}}");</span>
...
&nbsp;
  it('tokenizes a path with this/foo as OPEN ID SEP ID CLOSE', <span
								class="fstat-no" title="function not covered">function() {</span>
...
&nbsp;
  it('tokenizes a simple mustache with spaces as "OPEN ID CLOSE"', <span
								class="fstat-no" title="function not covered">function() {</span>
<span class="cstat-no" title="statement not covered">    var result = tokenize("{{  foo  }}");</span>
<span class="cstat-no" title="statement not covered">    shouldMatchTokens(result, ['OPEN', 'ID', 'CLOSE']);</span>
<span class="cstat-no" title="statement not covered">    shouldBeToken(result[1], "ID", "foo");</span>
...
&nbsp;
  it('tokenizes a simple mustache with line breaks as "OPEN ID ID CLOSE"', <span
								class="fstat-no" title="function not covered">function() {</span>
...
&nbsp;
  it('tokenizes raw content as "CONTENT"', <span class="fstat-no"
								title="function not covered">function() {</span>
<span class="cstat-no" title="statement not covered">    var result = tokenize("foo {{ bar }} baz");</span>
...
&nbsp;
  it('tokenizes a partial as "OPEN_PARTIAL ID CLOSE"', <span
								class="fstat-no" title="function not covered">function() {</span>
<span class="cstat-no" title="statement not covered">    var result = tokenize("{{&gt; foo}}");</span>
<span class="cstat-no" title="statement not covered">    shouldMatchTokens(result, ['OPEN_PARTIAL', 'ID', 'CLOSE']);</span>
  });
&nbsp;
  it('tokenizes a partial with context as "OPEN_PARTIAL ID ID CLOSE"', <span
								class="fstat-no" title="function not covered">function() {</span>
<span class="cstat-no" title="statement not covered">    var result = tokenize("{{&gt; foo bar }}");</span>
<span class="cstat-no" title="statement not covered">    shouldMatchTokens(result, ['OPEN_PARTIAL', 'ID', 'ID', 'CLOSE']);</span>
  });
&nbsp;
  it('tokenizes a partial without spaces as "OPEN_PARTIAL ID CLOSE"', <span
								class="fstat-no" title="function not covered">function() {</span>
<span class="cstat-no" title="statement not covered">    var result = tokenize("{{&gt;foo}}");</span>
<span class="cstat-no" title="statement not covered">    shouldMatchTokens(result, ['OPEN_PARTIAL', 'ID', 'CLOSE']);</span>
  });
&nbsp;
  it('tokenizes a partial space at the }); as "OPEN_PARTIAL ID CLOSE"', <span
								class="fstat-no" title="function not covered">function() {</span>
<span class="cstat-no" title="statement not covered">    var result = tokenize("{{&gt;foo  }}");</span>
<span class="cstat-no" title="statement not covered">    shouldMatchTokens(result, ['OPEN_PARTIAL', 'ID', 'CLOSE']);</span>
  });
...
&nbsp;
  it('tokenizes a comment as "COMMENT"', <span class="fstat-no"
								title="function not covered">function() {</span>
...
&nbsp;
  it('tokenizes a block comment as "COMMENT"', <span class="fstat-no"
								title="function not covered">function() {</span>
<span class="cstat-no" title="statement not covered">    var result = tokenize("foo {{!-- this is a {{comment}} --}} bar {{ baz }}");</span>
<span class="cstat-no" title="statement not covered">    shouldMatchTokens(result, ['CONTENT', 'COMMENT', 'CONTENT', 'OPEN', 'ID', 'CLOSE']);</span>
<span class="cstat-no" title="statement not covered">    shouldBeToken(result[1], "COMMENT", " this is a {{comment}} ");</span>
...
&nbsp;
  it('tokenizes a block comment with whitespace as "COMMENT"', <span
								class="fstat-no" title="function not covered">function() {</span>
...
&nbsp;
  it('tokenizes open and closing blocks as OPEN_BLOCK, ID, CLOSE ..., OPEN_ENDBLOCK ID CLOSE', <span
								class="fstat-no" title="function not covered">function() {</span>
...
&nbsp;
  it('tokenizes inverse sections as "OPEN_INVERSE CLOSE"', <span
								class="fstat-no" title="function not covered">function() {</span>
...
&nbsp;
  it('tokenizes inverse sections with ID as "OPEN_INVERSE ID CLOSE"', <span
								class="fstat-no" title="function not covered">function() {</span>
<span class="cstat-no" title="statement not covered">    var result = tokenize("{{^foo}}");</span>
...
&nbsp;
  it('tokenizes inverse sections with ID and spaces as "OPEN_INVERSE ID CLOSE"', <span
								class="fstat-no" title="function not covered">function() {</span>
<span class="cstat-no" title="statement not covered">    var result = tokenize("{{^ foo  }}");</span>
<span class="cstat-no" title="statement not covered">    shouldMatchTokens(result, ['OPEN_INVERSE', 'ID', 'CLOSE']);</span>
<span class="cstat-no" title="statement not covered">    shouldBeToken(result[1], "ID", "foo");</span>
...
&nbsp;
  it('tokenizes mustaches with params as "OPEN ID ID ID CLOSE"', <span
								class="fstat-no" title="function not covered">function() {</span>
<span class="cstat-no" title="statement not covered">    var result = tokenize("{{ foo bar baz }}");</span>
...
&nbsp;
  it('tokenizes mustaches with String params as "OPEN ID ID STRING CLOSE"', <span
								class="fstat-no" title="function not covered">function() {</span>
<span class="cstat-no" title="statement not covered">    var result = tokenize("{{ foo bar \"baz\" }}");</span>
...
&nbsp;
  it('tokenizes mustaches with String params using single quotes as "OPEN ID ID STRING CLOSE"', <span
								class="fstat-no" title="function not covered">function() {</span>
<span class="cstat-no" title="statement not covered">    var result = tokenize("{{ foo bar \'baz\' }}");</span>
<span class="cstat-no" title="statement not covered">    shouldMatchTokens(result, ['OPEN', 'ID', 'ID', 'STRING', 'CLOSE']);</span>
<span class="cstat-no" title="statement not covered">    shouldBeToken(result[3], "STRING", "baz");</span>
...
&nbsp;
  it('tokenizes String params with spaces inside as "STRING"', <span
								class="fstat-no" title="function not covered">function() {</span>
...
&nbsp;
  it('tokenizes String params with escapes quotes as STRING', <span
								class="fstat-no" title="function not covered">function() {</span>
<span class="cstat-no" title="statement not covered">    var result = tokenize('{{ foo "bar\\"baz" }}');</span>
...
&nbsp;
  it('tokenizes String params using single quotes with escapes quotes as STRING', <span
								class="fstat-no" title="function not covered">function() {</span>
<span class="cstat-no" title="statement not covered">    var result = tokenize("{{ foo 'bar\\'baz' }}");</span>
<span class="cstat-no" title="statement not covered">    shouldMatchTokens(result, ['OPEN', 'ID', 'STRING', 'CLOSE']);</span>
<span class="cstat-no" title="statement not covered">    shouldBeToken(result[2], "STRING", "bar'baz");</span>
...
&nbsp;
  it('tokenizes numbers', <span class="fstat-no"
								title="function not covered">function() {</span>
...
&nbsp;
  it('tokenizes booleans', <span class="fstat-no"
								title="function not covered">function() {</span>
...
&nbsp;
  it('tokenizes hash arguments', <span class="fstat-no"
								title="function not covered">function() {</span>
<span class="cstat-no" title="statement not covered">    var result = tokenize("{{ foo bar=baz }}");</span>
...
&nbsp;
  it('tokenizes special @ identifiers', <span class="fstat-no"
								title="function not covered">function() {</span>
<span class="cstat-no" title="statement not covered">    var result = tokenize("{{ @foo }}");</span>
...
&nbsp;
  it('does not time out in a mustache with a single } followed by EOF', <span
								class="fstat-no" title="function not covered">function() {</span>
<span class="cstat-no" title="statement not covered">    shouldMatchTokens(tokenize("{{foo}"), ['OPEN', 'ID']);</span>
  });
&nbsp;
  it('does not time out in a mustache when invalid ID characters are used', <span
								class="fstat-no" title="function not covered">function() {</span>
<span class="cstat-no" title="statement not covered">    shouldMatchTokens(tokenize("{{foo &amp; }}"), ['OPEN', 'ID']);</span>
  });
&nbsp;
  it('tokenizes subexpressions', <span class="fstat-no"
								title="function not covered">function() {</span>
<span class="cstat-no" title="statement not covered">    var result = tokenize("{{foo (bar)}}");</span>
...
&nbsp;
  it('tokenizes nested subexpressions', <span class="fstat-no"
								title="function not covered">function() {</span>
