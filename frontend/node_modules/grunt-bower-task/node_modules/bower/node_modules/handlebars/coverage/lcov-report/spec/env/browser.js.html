...
<body>
	<div class="header low">
		<h1>
			Code coverage report for <span class="entity">spec/env/browser.js</span>
		</h1>
		<h2>

			Statements: <span class="metric">46.15% <small>(6 /
					13)</small></span> &nbsp;&nbsp;&nbsp;&nbsp; Branches: <span class="metric">100%
				<small>(0 / 0)</small>
			</span> &nbsp;&nbsp;&nbsp;&nbsp; Functions: <span class="metric">0% <small>(0
					/ 3)</small></span> &nbsp;&nbsp;&nbsp;&nbsp; Lines: <span class="metric">46.15%
				<small>(6 / 13)</small>
